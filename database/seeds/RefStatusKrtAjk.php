...
class RefStatusKrtAjk extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if(DB::table('ref__status_krt_ajk')->get()->count() == 0){

            DB::table('ref__status_krt_ajk')->insert([
                ...
                [ 'id' => 5, 'status_description' => 'Disahkan', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                [ 'id' => 6, 'status_description' => 'Perlu Kemaskini', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ]);
