...
class Ref_Status_SPK_Imediator_Mediasi extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if(DB::table('ref__status_spk_imediator_mediasi')->get()->count() == 0){

            DB::table('ref__status_spk_imediator_mediasi')->insert([
                ...
                [ 'id' => 4, 'status_description' => 'Diakui Oleh PPD', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                [ 'id' => 5, 'status_description' => 'MKP Perlu Kemaskini', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                [ 'id' => 6, 'status_description' => 'Diakui Oleh PPMK', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
