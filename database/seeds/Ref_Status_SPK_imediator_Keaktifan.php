...
class Ref_Status_SPK_imediator_Keaktifan extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if(DB::table('ref__status_spk_imediator_keaktifan')->get()->count() == 0){

            DB::table('ref__status_spk_imediator_keaktifan')->insert([
                [ 'id' => 1, 'status_description' => 'Disahkan Oleh PPN', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                ...
                [ 'id' => 6, 'status_description' => 'Disokong Oleh PPMK', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                [ 'id' => 7, 'status_description' => 'MKP Perlu Kemaskini', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
                [ 'id' => 8, 'status_description' => 'MKP Perlu Kemaskini', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ]);
