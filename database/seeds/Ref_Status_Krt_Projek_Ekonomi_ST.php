...
class Ref_Status_Krt_Projek_Ekonomi_ST extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if(DB::table('ref__status_krt_projek_ekonomi_st')->get()->count() == 0){

            DB::table('ref__status_krt_projek_ekonomi_st')->insert([
