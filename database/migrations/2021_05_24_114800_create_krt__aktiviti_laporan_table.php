...
class CreateKrtAktivitiLaporanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('krt__aktiviti_laporan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('krt__aktiviti_laporan');
    }
}
