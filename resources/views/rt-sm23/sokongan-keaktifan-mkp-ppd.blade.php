                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="skmppd_mkp_nama" id="skmppd_mkp_nama" placeholder="No Kad Pengenalan" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Kad Pengenalan: </label>
                                                    <input type="text" class="form-control" name="skmppd_mkp_no_ic" id="skmppd_mkp_no_ic" placeholder="No Kad Pengenalan" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Telefon: </label>
                                                    <input type="text" class="form-control" name="skmppd_mkp_no_phone" id="skmppd_mkp_no_phone" placeholder="No Telefon" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Alamat Email: </label>
                                                    <input type="text" class="form-control" name="skmppd_mkp_email" id="skmppd_mkp_email" placeholder="Alamat Email" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form action="#" id="form_skmppd" >
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: </label>
                                                        <select class="form-control" name="skmppd_mkp_keaktifan_status" id="skmppd_mkp_keaktifan_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="4">Disokong</option>
                                                            <option value="5">Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_skmppd_mkp_keaktifan_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: </label>
                                                        <textarea class="form-control" rows="4" name="skmppd_disokong_note" id="skmppd_disokong_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_skmppd_disokong_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="spmpd_spk_mkp_keaktifan_id" id="spmpd_spk_mkp_keaktifan_id">
                                                            <input type="hidden" name="post_sokongan_mkp_keaktifan_ppd" value="edit">
                                                            <input type="hidden" name="action" id="post_sokongan_mkp_keaktifan_ppd" value="edit">
...
@include('js.rt-sm23.j-sokongan-keaktifan-mkp-ppd')
