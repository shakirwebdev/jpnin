                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="smku_state_id" name="smku_state_id">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="smku_daerah_id" name="smku_daerah_id" disabled>
...
@include('js.rt-sm23.j-senarai-mkp-keaktifan-upmk')