...
@section('title', 'Sokongan Permohonan Pendaftaran Mediator Komuniti')
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="spmmk_daerah_id" name="spmmk_daerah_id">
...
@include('js.rt-sm23.j-senarai-permohonan-mkp-ppmk')