...
@section('title', 'Kelulusan Permohonan Pendaftaran Mediator Komuniti')
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="spmkp_state_id" name="spmkp_state_id">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="spmkp_daerah_id" name="spmkp_daerah_id" disabled>
...
@include('js.rt-sm23.j-senarai-permohonan-mkp-kp')