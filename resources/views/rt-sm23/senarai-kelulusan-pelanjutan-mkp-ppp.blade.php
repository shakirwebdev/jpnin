...
@section('title', 'Senarai Kelulusan Permohonan Pelanjutan MKP')
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="skpmp_state_id" name="skpmp_state_id">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="skpmp_daerah_id" name="skpmp_daerah_id" disabled>
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Kelulusan Permohonan Pelanjutan MKP</h3>
                        </div>
...
@include('js.rt-sm23.j-senarai-kelulusan-pelanjutan-mkp-ppp')