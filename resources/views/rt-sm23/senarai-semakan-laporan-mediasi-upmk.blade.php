                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="sslmu_state_id" name="sslmu_state_id">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="sslmu_daerah_id" name="sslmu_daerah_id" disabled>
...
@include('js.rt-sm23.j-senarai-semakan-laporan-mediasi-upmk')