                                                ...
                                                @csrf
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            ...
                                                            <input type="hidden" name="post_sokongan_pelanjutan_mkp_ppd" value="edit">
                                                            <input type="hidden" name="action" id="post_sokongan_pelanjutan_mkp_ppd" value="edit">
...
@include('js.rt-sm23.j-sokongan-pelanjuatan-mkp-ppd')
