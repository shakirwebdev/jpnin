                                ...
                                <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_pelaksanaan_rondaan" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="background-color: #113f50" colspan="4" class="text-center"><font color="white">Minggu Pelaksanaan Rondaan</font></th>
                                            <th style="background-color: #113f50" rowspan="2"><font color="white">Bilangan<br>Pelaksanaan</font></th>
                                        </tr>
                                        <tr>
...
@include('js.rt-sm16.j-laporan-pelaksanaan-rondaan-ppn')
