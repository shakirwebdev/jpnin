...
@section('title', 'Jana Laporan Ringkasan Kekerapan Pelaksanaan Rondaan SRS Negeri')
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter table-hover display nowrap mb-0" id="senari_perancangan_rondaan" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">Bil</th>
                                                <th rowspan="2" class="text-center">Daerah</th>
...
@include('js.rt-sm16.j-laporan-kekerapan-pelaksanaan-rondaan-n')
