...
<script type="text/javascript"> 
    ...
    function memperakui_permohonan_insiden(){
        window.location.href = '{{route('rt-sm22.menyemak_muhibbah_admin_1')}}';
    }

    var dataSet = [ 
		["1", "Perlis", "Perlis", "Kuala Perlis", "Perjumpaan Rusuhan", "Mohamad Shauki Bin Sahardi", "Dihantar Untuk Semakan"]
	];
