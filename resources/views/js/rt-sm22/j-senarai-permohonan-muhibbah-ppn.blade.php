...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var senarai_permohonan_muhibbah_ppn_config = {
			routes: {
				senarai_permohonan_muhibbah_ppn_url: "/rt/sm22/senarai-permohonan-muhibbah-ppn"
			}
		};   
    	...
    	var senarai_permohonan_muhibbah = $('#senarai_permohonan_muhibbah').DataTable( {
			...
			ajax: {url: senarai_permohonan_muhibbah_ppn_config.routes.senarai_permohonan_muhibbah_ppn_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
	...
	function kemaskini_permohonan_imuhibbah(id){
		window.location.href = "{{ route('rt-sm22.permohonan_muhibbah_ppn','') }}"+"/"+id;
	}
