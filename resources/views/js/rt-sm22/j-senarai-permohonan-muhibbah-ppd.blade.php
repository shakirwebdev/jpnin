...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var senarai_permohonan_muhibbah_ppd_config = {
			routes: {
				senarai_permohonan_muhibbah_ppd_url: "/rt/sm22/senarai-permohonan-muhibbah-ppd"
			}
		};   
    	...
    	var senarai_permohonan_muhibbah = $('#senarai_permohonan_muhibbah').DataTable( {
			...
			ajax: {url: senarai_permohonan_muhibbah_ppd_config.routes.senarai_permohonan_muhibbah_ppd_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
	...
	function kemaskini_permohonan_imuhibbah(id){
		window.location.href = "{{ route('rt-sm22.permohonan_muhibbah_ppd','') }}"+"/"+id;
	}
