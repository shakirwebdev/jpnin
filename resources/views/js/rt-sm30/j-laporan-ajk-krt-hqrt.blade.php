...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
        ...
        $("#lakhq_state_id").on( 'change', function () {
			laporan_ajk_krt_hqrt.columns(1).search($(this).val()).draw();
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
        ...
        $("#lakhq_parlimen_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(3).search($(this).val()).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
        ...
        $("#lakhq_dun_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(4).search($(this).val()).draw();
		});

        $("#lakhq_daerah_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(2).search($(this).val()).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
        ...
        $("#lakhq_krt_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(7).search($(this).val()).draw();
		});

        $("#lakhq_kaum_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(12).search($(this).val()).draw();
		});

        $("#lakhq_pendidikan_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(14).search($(this).val()).draw();
		});

        $("#lakhq_jawatan_id").on( 'change', function () {
			//laporan_ajk_krt_hqrt.search( $(this).val() ).draw();
			laporan_ajk_krt_hqrt.columns(16).search($(this).val()).draw();
		});
		
		$("#lakppd_penggal_id").on( 'change', function () {
			var aa=$("#lakppd_penggal_id option:selected" ).text().substr(0, 4);
			laporan_ajk_krt_hqrt.columns(5).search(aa).draw();
		});
