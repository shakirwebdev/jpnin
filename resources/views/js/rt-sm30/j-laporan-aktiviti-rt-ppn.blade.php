...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_aktiviti_config = {
			routes: {
				laporan_aktiviti_url: "/rt/sm30/laporan-aktiviti-rt-ppn"
			}
		}; 
