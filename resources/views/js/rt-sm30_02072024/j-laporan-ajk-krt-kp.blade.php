...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_ajk_krt_config = {
			routes: {
				laporan_ajk_krt_url: "/rt/sm30/laporan-ajk-krt-kp"
			}
		}; 

        $("#lakkp_state_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
            $('#lakkp_daerah_id').find('option').remove();
            $('#lakkp_daerah_id').prop("disabled", false);
            if (selectedIndex !== '0') {
                $.ajax({
                    type: "GET",
                    ...
                    success: function (data) {
                        $('#lakkp_daerah_id').append($('<option>').text('-- Sila Pilih --').attr('value', ''));
        ...
        $("#lakkp_state_id").on( 'change', function () {
			...
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
            $('#lakkp_parlimen_id').find('option').remove();
            $('#lakkp_parlimen_id').prop("disabled", false);
            if (selectedIndex !== '0') {
                $.ajax({
                    type: "GET",
                    url: laporan_ajk_krt_config.routes.laporan_ajk_krt_url,
                    ...
                    success: function (data) {
                        $('#lakkp_parlimen_id').append($('<option>').text('-- Sila Pilih --').attr('value', ''));
                        $.each(data,function(key, obj) 
                        {
                            $('#lakkp_parlimen_id')
                            .append($('<option>')
        ...
        $("#lakkp_parlimen_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
            $('#lakkp_dun_id').find('option').remove();
            $('#lakkp_dun_id').prop("disabled", false);
            if (selectedIndex !== '0') {
                $.ajax({
                    type: "GET",
                    url: laporan_ajk_krt_config.routes.laporan_ajk_krt_url,
                    ...
                    success: function (data) {
                        $('#lakkp_dun_id').append($('<option>').text('-- Sila Pilih --').attr('value', ''));
                        $.each(data,function(key, obj) 
                        {
                            $('#lakkp_dun_id')
                            .append($('<option>')
        ...
        $("#lakkp_dun_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
		});

        $("#lakkp_daerah_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
			var value = $(this).find('option:selected').val();
			var selectedIndex = $(this).find('option:selected').index();
            $('#lakkp_krt_id').find('option').remove();
            $('#lakkp_krt_id').prop("disabled", false);
            if (selectedIndex !== '0') {
                $.ajax({
                    type: "GET",
                    url: laporan_ajk_krt_config.routes.laporan_ajk_krt_url,
                    ...
                    success: function (data) {
                        $('#lakkp_krt_id').append($('<option>').text('-- Sila Pilih --').attr('value', ''));
                        $.each(data,function(key, obj) 
                        {
                            $('#lakkp_krt_id')
                            .append($('<option>')
        ...
        $("#lakkp_krt_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
		});

        $("#lakkp_kaum_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
		});

        $("#lakkp_pendidikan_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
		});

        $("#lakkp_jawatan_id").on( 'change', function () {
			laporan_ajk_krt.search( $(this).val() ).draw();
		});
