...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_ajk_pendidikan_config = {
			routes: {
				laporan_ajk_pendidikan_url: "/rt/sm30/laporan-ajk-pendidikan-ppn"
			}
		};  
        
        $("#lappn_daerah_id").on( 'change', function () {
			senarai_ajk_pendidikan.column('2:visible').search( $(this).val() ).draw();
            ...
            if (selectedIndex !== '0') {
                $.ajax({
                    type: "GET",
                    url: laporan_ajk_pendidikan_config.routes.laporan_ajk_pendidikan_url,
