...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var permohonan_laporan_mediasi_config = {
			routes: {
				permohonan_laporan_mediasi_url: "/rt/sm26/pengesahan-laporan-kes-mediasi-admin"
			}
		};   
    ...
    function akuan_laporan_kes(){
        window.location.href = '{{route('rt-sm26.pengesahan_laporan_kes_mediasi_admin_1')}}';
    }

    var dataSet = [ 
		["1", "Perlis", "Perlis", "Kepenggunaan", "1/1/2021", "Mohamad Shauki Bin Sahardi", "930508095161", "Dihantar Untuk Pengesahan"]
	];
