	...
	$(document).ready( function () {
        ...
        /* Button */
            $('#btn_back').click(function(){
                window.location.href = "{{ route('rt-sm10.senarai_kanta_komuniti_ppd_1','') }}"+"/"+"{{$kanta_komuniti->id}}";
            });

            $('#btn_next').click(function(){
                window.location.href = "{{ route('rt-sm10.senarai_kanta_komuniti_ppd_3','') }}"+"/"+"{{$kanta_komuniti->id}}";
            });
	});
