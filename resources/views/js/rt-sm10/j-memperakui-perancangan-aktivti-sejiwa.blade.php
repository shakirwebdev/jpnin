...
<script type="text/javascript">    
		    ...
		    columns: [
	            ...
	            {data : null, bSortable: false, sClass: 'text-center',
                    mRender: function (value, type, full) {
                    	button_a = '<button type="button" class="btn btn-icon" title="Kemaskini" id="edit-jpnin" data-id="" onclick="memperakui_perancangan_sejiwa();"><font color="red"><i class="fe fe-edit-3"></i></font></button>';
    ...
    function memperakui_perancangan_sejiwa(){
        window.location.href = '{{route('rt-sm10.memperakui_perancangan_aktivti_sejiwa_ppn')}}';
    }
