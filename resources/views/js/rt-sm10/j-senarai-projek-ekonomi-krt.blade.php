...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		var senarai_projek_ekonomi_config = {
			routes: {
				senarai_projek_ekonomi_url: "/rt/sm10/senarai-projek-ekonomi-krt"
			}
		};
		...
		var senarai_projek_ekonomi = $('#senarai_projek_ekonomi').DataTable( {
            ...
            rowCallback: function(nRow, aData, index) {
                var info = senarai_projek_ekonomi.page.info();
	...
	function paparan_projek_ekonomi(id){
		window.location.href = "{{ route('rt-sm10.senarai_projek_ekonomi_krt_1','') }}"+"/"+id;
	}
