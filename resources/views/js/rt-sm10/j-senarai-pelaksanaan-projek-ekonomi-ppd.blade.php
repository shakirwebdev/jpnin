...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		var senarai_pelaksanaan_projek_ekonomi_st_config = {
			routes: {
				senarai_pelaksanaan_projek_ekonomi_st_url: "/rt/sm10/senarai-pelaksanaan-projek-ekonomi-ppd"
			}
		};

        $("#sppepd_krt_id").on( 'change', function () {
	...
	function paparan_pelaksanaan_projek_ekonomi(id){
		window.location.href = "{{ route('rt-sm10.senarai_pelaksanaan_projek_ekonomi_ppd_1','') }}"+"/"+id;
	}
