...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var permohonan_pelaporan_ikes_ppn_config = {
			routes: {
				permohonan_pelaporan_ikes_ppn_url: "/rt/sm21/senarai-permohonan-ikes-ppn"
			}
		};   
    	...
    	var senarai_permohonan_pelaporan_ikes = $('#senarai_permohonan_pelaporan_ikes').DataTable( {
			...
			ajax: {url: permohonan_pelaporan_ikes_ppn_config.routes.permohonan_pelaporan_ikes_ppn_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
	...
	function kemaskini_permohonan_ikes(id){
		window.location.href = "{{ route('rt-sm21.permohonan_ikes_ppn','') }}"+"/"+id;
	}
