...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var permohonan_pelaporan_ikes_bpp_config = {
			routes: {
				permohonan_pelaporan_ikes_bpp_url: "/rt/sm21/senarai-permohonan-ikes-bpp"
			}
		};   
    	...
    	var senarai_permohonan_pelaporan_ikes = $('#senarai_permohonan_pelaporan_ikes').DataTable( {
			...
			ajax: {url: permohonan_pelaporan_ikes_bpp_config.routes.permohonan_pelaporan_ikes_bpp_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
	...
	function kemaskini_permohonan_ikes(id){
		window.location.href = "{{ route('rt-sm21.permohonan_ikes_bpp','') }}"+"/"+id;
	}
