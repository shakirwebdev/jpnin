...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
        ...
        var senarai_ops_rondaan_config = {
            routes: {
                senarai_ops_rondaan_config_url: "/rt/sm14/paparan-pemakluman-ops-rondaan-ppd"
            }
        };
        ...
        $("#pporpd_srs_id").on( 'change', function () {
	...
	function view_pemakluman_ops_rondaan(id){
		window.location.href = "{{ route('rt-sm14.surat_pemakluman_operasi_rondaan_ppd','') }}"+"/"+id;
	}
