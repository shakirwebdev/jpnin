...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		/* Maklumat Pemohonan Ahli KRT */
			...
			$('#kak_ajk_penggal').val("{{$krt_ajk->penggal_mula}}"+"/"+"{{$krt_ajk->penggal_tamat}}");
			...
			if($('#kak_ajk_ic').val() !== "")
			{
				var ic = $('#kak_ajk_ic').val().substr(0,2);
				if(ic !== "")
				{
					var dob_tahun="";
					if(ic >= 30)
					{
						dob_tahun="19" + $('#kak_ajk_ic').val().substr(0,2);
					}else
					{
						dob_tahun="20" + $('#kak_ajk_ic').val().substr(0,2);
					}
					var dob_bulan=$('#kak_ajk_ic').val().substr(2,2);
					var dob_hari=$('#kak_ajk_ic').val().substr(4,2);
					...
					$('#kak_ajk_tarikh_lahir').val(dob_hari+"/"+dob_bulan+"/"+dob_tahun);
					$('#kak_ajk_k_umur').val(today_tahun-dob_tahun);
				}else
				{
					$('#kak_ajk_tarikh_lahir').val(null);
					$('#kak_ajk_k_umur').val(null);
				}
			}
