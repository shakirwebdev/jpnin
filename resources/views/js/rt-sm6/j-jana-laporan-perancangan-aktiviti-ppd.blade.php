...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
		...
		var senarai_aktivitin_config = {
			routes: {
				senarai_aktiviti_url: "/rt/sm6/jana-laporan-perancangan-aktiviti-ppd"
			}
		};

        $("#jlpapd_krt_id").on( 'change', function () {
    ...
    function laporan_perancangan_aktiviti(id){
		window.location.href = "{{ route('rt-sm6.jana_laporan_perancangan_aktiviti_ppd_1','') }}"+"/"+id;
	}
