    ...
    $(document).ready( function () {
    	...
    	/* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.pengesahan_perancangan_aktiviti_ppd_1','')}}'+'/'+"{{$perancangan_aktiviti->id}}";
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.pengesahan_perancangan_aktiviti_ppd_3','')}}'+'/'+"{{$perancangan_aktiviti->id}}";
            });
    });
