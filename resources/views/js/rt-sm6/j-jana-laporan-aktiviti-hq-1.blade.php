...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
		...
		var laporan_aktiviti_config = {
			routes: {
				laporan_aktiviti_url: "/rt/sm6/jana-laporan-aktiviti-hq-1/{{$laporan_aktiviti->id}}"
			}
		};
        ...
        /* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_hq')}}';
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_hq_2','')}}'+'/'+'{{$laporan_aktiviti->id}}';
            });
