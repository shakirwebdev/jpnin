...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
		...
		var perancangan_aktiviti_config = {
			routes: {
				perancangan_aktiviti_url: "/rt/sm6/jana-laporan-perancangan-aktiviti-krt-1/{{$perancangan_aktiviti->id}}"
			}
		};
        ...
        /* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_perancangan_aktiviti_krt')}}';
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_perancangan_aktiviti_krt_2','')}}'+'/'+'{{$perancangan_aktiviti->id}}';
            });
