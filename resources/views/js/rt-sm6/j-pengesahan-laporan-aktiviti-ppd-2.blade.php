    ...
    $(document).ready( function () {
    	...
    	/* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.pengesahan_laporan_aktiviti_ppd_1','')}}'+'/'+"{{$laporan_aktiviti->id}}";
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.pengesahan_laporan_aktiviti_ppd_3','')}}'+'/'+"{{$laporan_aktiviti->id}}";
            });
    });
