    ...
    $(document).ready( function () {
    	...
    	/* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_ppn_1','')}}'+'/'+"{{$laporan_aktiviti->id}}";
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_ppn_3','')}}'+'/'+"{{$laporan_aktiviti->id}}";
            });
    });
