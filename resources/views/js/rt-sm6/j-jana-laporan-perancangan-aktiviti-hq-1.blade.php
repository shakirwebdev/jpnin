...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
		...
		var perancangan_aktiviti_config = {
			routes: {
				perancangan_aktiviti_url: "/rt/sm6/jana-laporan-perancangan-aktiviti-hq-1/{{$perancangan_aktiviti->id}}"
			}
		};
        ...
        /* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_perancangan_aktiviti_hq')}}';
            });
