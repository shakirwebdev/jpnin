...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
		...
		var laporan_aktiviti_config = {
			routes: {
				laporan_aktiviti_url: "/rt/sm6/jana-laporan-aktiviti-ppd-1/{{$laporan_aktiviti->id}}"
			}
		};
        ...
        /* Button */
            $('#btn_back').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_ppd')}}';
            });

            $('#btn_next').click(function(){
                window.location.href = '{{route('rt-sm6.jana_laporan_aktiviti_ppd_2','')}}'+'/'+'{{$laporan_aktiviti->id}}';
            });
