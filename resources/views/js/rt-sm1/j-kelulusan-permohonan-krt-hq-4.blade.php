...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		$('#kpkh4_krt_status_bagunan_id').val("{{$profile_krt->krt_status_bagunan_id}}");

		if($('#kpkh4_krt_status_bagunan_id').val() == '1'){
			$(".for_binaan").css("display", "block");
			$(".for_tumpang").css("display", "none");
		} else if ($('#kpkh4_krt_status_bagunan_id').val() == '2') {
			$(".for_binaan").css("display", "none");
			$(".for_tumpang").css("display", "block");
		} else if ($('#kpkh4_krt_status_bagunan_id').val() == '3') {
			$(".for_binaan").css("display", "none");
			$(".for_tumpang").css("display", "none");
		}
		...
		$('#btn_next').click(function(){
			window.location.href = "{{route('rt-sm1.kelulusan_permohonan_krt_hq_5','')}}"+"/"+{{$profile_krt->id}};
		});
