...
<script type="text/javascript">    
	...
	function kembali()
	{
		...
		}else
		{
			if($("#krkr_kewangan_tarikh_t_b").val() == "")
			{
				...
				$('.error_krkr_kewangan_tarikh_t_b').html("Tarikh perlu diisi");
			}else
			{
				if($("#krkr_kewangan_tarikh_t_b").val().length < 10)
				{
					$('[name=krkr_kewangan_tarikh_t_b]').addClass("is-invalid");
					$('.error_krkr_kewangan_tarikh_t_b').html("Tarikh tidak sah");
				}else
				{
					if($("#krkr_kewangan_tarikh_t_b").val().substr(6, 1) != "2")
					{
						$('[name=krkr_kewangan_tarikh_t_b]').addClass("is-invalid");
						$('.error_krkr_kewangan_tarikh_t_b').html("Tarikh tidak sah");
					}else
					{
						...
						$.ajax({
							...
							if(response.errors)
							{
								if(response.errors == 3)
								{
									$('[name=krkr_kewangan_time_t_b]').addClass("is-invalid");
									$('.error_krkr_kewangan_time_t_b').html("Tarikh dan masa telah wujud");
								}	
							} else {
								window.location.href = "{{route('rt-sm7.senarai_rekod_kewangan_rt')}}";
							}
	...
	$(document).ready( function () {
		...
		$('#krkr_kewangan_time_t_b').inputmask('hh:mm', { 
		...
		$("#upload_dokumen").click(function(){
				...
				$.ajax({
					...
					async: false,
						...
						$('[name=krkr_kewangan_tarikh_cek]').removeClass("is-invalid");
						...
						if(response.errors)
						{
							$.each(response.errors, function(index, error){
								...
								if(index == 'krkr_kewangan_tarikh_cek') {
									$('[name=krkr_kewangan_tarikh_cek]').addClass("is-invalid");
									$('.error_krkr_kewangan_tarikh_cek').html(error);
								}
    ...
    /* action submit */
        ...
        $(document).on('submit', '#form_krkr', function(event){    
            ...
            $.ajax({
				...
				$('[name=krkr_kewangan_time_t_b]').removeClass("is-invalid");
            ...
            if(response.errors){
				if(response.errors == 3)
				{
					alert("Tarikh dan masa dah wujud");
					$('[name=krkr_kewangan_time_t_b]').addClass("is-invalid");
					$('.error_krkr_kewangan_time_t_b').html("Tarikh dan masa telah wujud");
				}else
				{
					$.each(response.errors, function(index, error){
						...
						if(index == 'krkr_kewangan_time_t_b') {
							$('[name=krkr_kewangan_time_t_b]').addClass("is-invalid");
							$('.error_krkr_kewangan_time_t_b').html(error);
						}
