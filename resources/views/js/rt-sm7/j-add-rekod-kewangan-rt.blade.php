...
<script type="text/javascript">    
	...
	function kembali()
	{
		...
		}else
		{
			if($("#arkr_kewangan_tarikh_t_b").val() == "")
			{
				...
				$('.error_arkr_kewangan_tarikh_t_b').html("Tarikh perlu diisi");
			}else
			{
				if($("#arkr_kewangan_tarikh_t_b").val().length < 10)
				{
					$('[name=arkr_kewangan_tarikh_t_b]').addClass("is-invalid");
					$('.error_arkr_kewangan_tarikh_t_b').html("Tarikh tidak sah");
				}else
				{
					if($("#arkr_kewangan_tarikh_t_b").val().substr(6, 1) != "2")
					{
						$('[name=arkr_kewangan_tarikh_t_b]').addClass("is-invalid");
						$('.error_arkr_kewangan_tarikh_t_b').html("Tarikh tidak sah");
					}else
						...
						$.ajax({
							...
							if(response.errors)
							{
								if(response.errors == 3)
								{
									...
									$('.error_arkr_kewangan_time_t_b').html("Tarikh dan masa telah wujud");
								}	
							}else
							{
								window.location.href = "{{route('rt-sm7.senarai_rekod_kewangan_rt')}}";
	...
	$(document).ready( function () {
		...
		$('#arkr_kewangan_time_t_b').inputmask('hh:mm', { 
		...
		$.fn.kira_baki = function() { 
			...
			console.log("yee:",$('#arkr_kewangan_baki_tunai').val());
		};
    ...
    /* Maklumat Kewangan Rukun Tetangga */
		...
		// $('#arkr_kewangan_baki_tunai').val("{{$krt_profile->krt_bank_baki_cash}}");
		...
		var senarai_trx = $('#senarai_trx').DataTable( {
			...
			$("#upload_dokumen").click(function(){
				...
				form_data.append("arkr_kewangan_nama_bank",$("#arkr_kewangan_jenis_kewangan").val());
				...
				form_data.append("arkr_kewangan_baki_tunai",$("#kewangan_baki_tunai").val());
