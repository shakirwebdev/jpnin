@include('js.modal.j-modal-print-perancangan-rondaan')
@section('page-script')
		    ...
		    columns: [
	            ...
	            {data : null, bSortable: false, sClass: 'text-center',
                    mRender: function (value, type, full) {
                        button_a = '<button type="button" class="btn btn-icon" title="Semak Borang Pendaftaran" id="edit-jpnin" data-id="" onclick="load_print_perancangan_rondaan();"><i class="fa fa-print"></i></button>';
                    return button_a;
                    }
                },
	        ]
