    ...
    $(document).ready( function () {
		...
		var senarai_kewangan_rt_table = $('#senarai_kewangan_rt_table').DataTable( {
            ...
            rowCallback: function(nRow, aData, index) {
                var info = senarai_kewangan_rt_table.page.info();
			...
			"aoColumnDefs":[{          
				...
				sClass: 'text-center',
                "mRender": function ( value, type, full )  {
                    if (full.kewangan_status == '3') {
                        button_a = '<button type="button" class="btn btn-icon" title="Kemaskini pendaftaran ahli KRT" onclick="pengesahan_rekod_kewangan_rt(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					    return button_a;
                    } else {
                        button_b = '';
                        return button_b;
