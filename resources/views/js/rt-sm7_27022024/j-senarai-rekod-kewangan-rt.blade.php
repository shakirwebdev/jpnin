    ...
    $(document).ready( function () {
		...
		var senarai_kewangan_rt_table = $('#senarai_kewangan_rt_table').DataTable( {
			...
			"aoColumnDefs":[{          
				...
				sClass: 'text-center',
                "mRender": function ( value, type, full )  {
                    if (full.kewangan_status == '4') {
                        button_a = '<button type="button" class="btn btn-icon" title="Kemaskini Kewangan RT" onclick="kemaskini_kewangan_rt(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					    return button_a;
                    }else if (full.kewangan_status == '5') {
                        button_a = '<button type="button" class="btn btn-icon" title="Kemaskini Kewangan RT" onclick="kemaskini_kewangan_rt(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					    return button_a;
                    } else {
                        button_b = '';
