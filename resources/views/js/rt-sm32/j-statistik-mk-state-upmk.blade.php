...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_ikes_kategori_config = {
			routes: {
				laporan_ikes_kategori_url: "/rt/sm32/statistik-mk-state-upmk"
			}
		}; 

		var statistik_mk_kategori = $('#statistik_mk_kategori').DataTable( {
    		processing: true,
        	serverSide: true,
            ...
            buttons: [
                {
                    extend: 'pdfHtml5',
                    title: 'Statistik Mediator Komuniti Mengikut Kategori',
            ...
            rowCallback: function(nRow, aData, index) {
                var info = statistik_mk_kategori.page.info();
