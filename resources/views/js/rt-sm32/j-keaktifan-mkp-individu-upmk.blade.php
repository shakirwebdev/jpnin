...
<script type="text/javascript">    
	...
	$(document).ready( function () {
        ...
        /* Maklumat MKP */
			$('#kmpd_mkp_nama').val("{{$mkp->mkp_nama}}");
            $('#kmpd_mkp_no_ic').val("{{$mkp->mkp_no_ic}}");
            $('#kmpd_mkp_no_phone').val("{{$mkp->mkp_no_phone}}");
			$('#kmpd_mkp_email').val("{{$mkp->user_email}}");
		...
		/* Button */
			$('#btn_back').click(function(){
				window.location.href = "{{ route('rt-sm32.laporan_keaktifan_mk_upmk') }}";
			});
