...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var statistik_kaum_config = {
			routes: {
				statistik_kaum_url: "/rt/sm32/statistik-mk-kaum-ppmk"
			}
		}; 

        var statistik_mk_kaum = $('#statistik_mk_kaum').DataTable( {
    		processing: true,
        	serverSide: true,
            ...
            iDisplayLength: -1,
            ajax: {url: statistik_kaum_config.routes.statistik_kaum_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
            ...
            rowCallback: function(nRow, aData, index) {
                var info = statistik_mk_kaum.page.info();
