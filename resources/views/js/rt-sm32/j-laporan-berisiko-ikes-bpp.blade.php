...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_berisiko_ikes_config = {
			routes: {
				laporan_berisiko_ikes_1_url: "{{ route('rt-sm32.laporan_berisiko_ikes_bpp') }}",
				laporan_berisiko_ikes_2_url: "{{ route('rt-sm32.laporan_berisiko_ikes_2_bpp') }}",
				laporan_berisiko_ikes_3_url: "{{ route('rt-sm32.laporan_berisiko_ikes_3_bpp') }}"
			}
		}; 
