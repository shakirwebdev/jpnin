...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var laporan_berisiko_ikes_config = {
			routes: {
				laporan_berisiko_ikes_1_url: "{{ route('rt-sm32.laporan_berisiko_ikes_p') }}",
				laporan_berisiko_ikes_2_url: "{{ route('rt-sm32.laporan_berisiko_ikes_2_p') }}",
				laporan_berisiko_ikes_3_url: "{{ route('rt-sm32.laporan_berisiko_ikes_3_p') }}"
			}
		}; 
