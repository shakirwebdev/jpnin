@include('js.modal.j-modal-view-kad-ahli-peronda-srs')
@section('page-script')
		    ...
		    columns: [
	            ...
	            {data : null, bSortable: false, sClass: 'text-center',
                    mRender: function (value, type, full) {
                    	button_a = '<button type="button" class="btn btn-icon" title="Semak Borang Pendaftaran" id="edit-jpnin" data-id="" onClick="load_view_kad_ahli_peronda_srs();"><font color="red"><i class="fe fe-edit-3"></i></font></button>';
                	return button_a;
                    }
                },
	        ]
