...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		//my custom script
			var senarai_ahli_peronda_config = {
                routes: {
                    senarai_senarai_ahli_peronda_config_url: "/rt/sm13/senarai-ahli-peronda-srs-hq"
                }
		    };

            $("#apshq_state_id").on( 'change', function () {
            ...
            var senarai_ahli_peronda_srs_table = $('#senarai_ahli_peronda_srs_table').DataTable( {
                ...
                "aoColumnDefs":[{          
                    ...
                    "mRender": function ( value, type, full )  {
                        if (full.status == '1') {
                            button_a = '<button type="button" class="btn btn-icon" title="Semak Pendaftaran Ahli Peronda SRS" onclick="view_ahli_peronda_srs(\'' + full.id + '\');"><i class="fa fa-search"></i></button>';
                            return button_a;
                        } else {
                            button_b = '';
                            return button_b;
	...
	function view_ahli_peronda_srs(id){
		window.location.href = "{{ route('rt-sm13.senarai_ahli_peronda_srs_hq_1','') }}"+"/"+id;
	}
