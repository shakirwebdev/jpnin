...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		//my custom script
			var senarai_ahli_peronda_config = {
                routes: {
                    senarai_senarai_ahli_peronda_config_url: "/rt/sm13/senarai-ahli-peronda-srs-ppd"
                }
		    };

            $("#saspd_krt_id").on( 'change', function () {
	...
	function view_ahli_peronda_srs(id){
		window.location.href = "{{ route('rt-sm13.senarai_ahli_peronda_srs_ppd_1','') }}"+"/"+id;
	}
