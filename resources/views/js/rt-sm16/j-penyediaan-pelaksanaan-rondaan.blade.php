		    ...
		    columns: [
	            ...
	            {data : null, bSortable: false, sClass: 'text-center',
                    mRender: function (value, type, full) {
                        button_a = '<button type="button" class="btn btn-icon" title="Semak Borang Pendaftaran" id="edit-jpnin" data-id="" onclick="load_pelaksanaan_rondaan();"><i class="fe fe-edit-3 text-danger"></i></button>';
                    return button_a;
                    }
                },
	        ]
