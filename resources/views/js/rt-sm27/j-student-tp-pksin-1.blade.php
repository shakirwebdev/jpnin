...
<script type="text/javascript">  
	...
	$(document).ready( function () {
		...
		/* Bahagian B : Maklumat Ibu */
			$('#stpksn_ibu_nama').val("{{$tbk_student->ibu_nama}}");
			$('#stpksn_ibu_pekerjaan').val("{{$tbk_student->ibu_pekerjaan}}");
			$('#stpksn_ibu_profession_id').val("{{$tbk_student->ibu_profession_id}}");
			$('#stpksn_ibu_pendapatan').val("{{$tbk_student->ibu_pendapatan}}");
			$('#stpksn_ibu_kerakyatan_id').val("{{$tbk_student->ibu_kerakyatan_id}}");
			$('#stpksn_ibu_jumlah_pendapatan').val("{{$tbk_student->ibu_jumlah_pendapatan}}");
			$('#stpksn_ibu_jumlah_pendapatan_lain').val("{{$tbk_student->ibu_jumlah_pendapatan_lain}}");
			$('#stpksn_ibu_ic').val("{{$tbk_student->ibu_ic}}");
			$('#stpksn_ibu_alamat_office').val("{{$tbk_student->ibu_alamat_office}}");
			$('#stpksn_ibu_phone_office').val("{{$tbk_student->ibu_phone_office}}");
			$('#stpksn_ibu_phone').val("{{$tbk_student->ibu_phone}}");
			$('#stpksn_ibu_phone_rumah').val("{{$tbk_student->ibu_phone_rumah}}");
			$('#stpksn_ibu_bil_anak').val("{{$tbk_student->ibu_bil_anak}}");
			$('#stpksn_ibu_hubungan_student').val("{{$tbk_student->ibu_hubungan_student}}");
			$('#stpksn_ibu_pilihan').val("{{$tbk_student->ibu_pilihan}}");
			$('#stpksn_ibu_bil_anak_sekolah').val("{{$tbk_student->ibu_bil_anak_sekolah}}");
			$('#stpksn_ibu_tabika_lain').val("{{$tbk_student->ibu_tabika_lain}}");
            $('#stpksn_student_id').val("{{$tbk_student->id}}");
			$('#stpksn_1_student_id').val("{{$tbk_student->id}}");
		...
		/* Button */
			$('#btn_back').click(function(){
				window.location.href = "{{route('rt-sm27.student_tp_pksin','')}}"+"/"+"{{$tbk_student->id}}";
			});
	});
