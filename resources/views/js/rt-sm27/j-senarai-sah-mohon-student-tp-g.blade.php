...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var senarai_permohonan_student_tp_g_config = {
			routes: {
				senarai_permohonan_student_tp_g_url: "/rt/sm27/senarai-sah-mohon-student-tp-g"
			}
		};   
    	...
    	var list_mohon_masuk_tabika = $('#list_mohon_masuk_tabika').DataTable( {
			...
			"aoColumnDefs":[{          
                ...
                sClass: 'text-center',
                "mRender": function ( value, type, full )  {
                    button_a = '<button type="button" class="btn btn-icon" title="Pengesahan Permohonan Kemasukan Tabika Perpaduan" onclick="sah_mohon_student_tp_g(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					return button_a;
                }
            }],
            "order": [[ 0, 'asc' ]],
    ...
    function sah_mohon_student_tp_g(id){
		window.location.href = "{{ route('rt-sm27.sah_mohon_student_tp_g','') }}"+"/"+id;
	}
