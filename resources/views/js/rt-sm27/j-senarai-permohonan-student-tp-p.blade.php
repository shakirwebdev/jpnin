...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var senarai_permohonan_student_tp_p_config = {
			routes: {
				senarai_permohonan_student_tp_p_url: "/rt/sm27/senarai-permohonan-student-tp-p"
			}
		};   
    	...
    	var list_mohon_masuk_tabika = $('#list_mohon_masuk_tabika').DataTable( {
            ...
            ajax: {url: senarai_permohonan_student_tp_p_config.routes.senarai_permohonan_student_tp_p_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
			...
			"aoColumnDefs":[{          
                ...
                sClass: 'text-center',
                "mRender": function ( value, type, full )  {
                    if (full.status == 2 || full.status == 4 || full.status == 6) {
