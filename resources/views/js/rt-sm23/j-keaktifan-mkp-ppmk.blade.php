...
<script type="text/javascript">    
	...
	$(document).ready( function () {
        ...
        /* Maklumat MKP */
			$('#kmpmk_mkp_nama').val("{{$mkp->mkp_nama}}");
            $('#kmpmk_mkp_no_ic').val("{{$mkp->mkp_no_ic}}");
            $('#kmpmk_mkp_no_phone').val("{{$mkp->mkp_no_phone}}");
			$('#kmpmk_mkp_email').val("{{$mkp->user_email}}");
		...
		/* Button */
			$('#btn_back').click(function(){
				window.location.href = "{{ route('rt-sm23.senarai_mkp_keaktifan_ppmk') }}";
			});
