...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		var senarai_sokongan_pelanjutan_mkp_config = {
			routes: {
				senarai_sokongan_pelanjutan_mkp_url: "/rt/sm23/senarai-sokongan-pelanjutan-mkp-ppmk"
			}
		};   

        $("#sspmmk_daerah_id").on( 'change', function () {
	...
	function sokongan_pelanjutan_mkp(id){
		window.location.href = "{{ route('rt-sm23.sokongan_pelanjuatan_mkp_ppmk','') }}"+"/"+id;
	}
