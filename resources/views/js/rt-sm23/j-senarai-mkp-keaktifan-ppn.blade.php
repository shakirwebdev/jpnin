...
<script type="text/javascript"> 
	...
	$(document).ready( function () {
		...
		//my custom script
		var sokongan_mkp_keaktifan_ppn_config = {
			routes: {
				sokongan_mkp_keaktifan_ppn_url: "/rt/sm23/senarai-mkp-keaktifan-ppn"
			}
		};  

        $("#smkpn_daerah_id").on( 'change', function () {
    	...
    	var senarai_keaktifan_mkp = $('#senarai_keaktifan_mkp').DataTable( {
			...
			ajax: {url: sokongan_mkp_keaktifan_ppn_config.routes.sokongan_mkp_keaktifan_ppn_url},
        	"language": {
	            "paginate": {
	                "previous": "Sebelumnya",
	                "next": "Seterusnya",
	...
	function paparan_keaktifan_mkp_ppd(id){
		window.location.href = "{{ route('rt-sm23.keaktifan_mkp_ppn','') }}"+"/"+id;
	}
