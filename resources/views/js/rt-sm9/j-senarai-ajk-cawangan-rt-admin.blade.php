...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		var senarai_permohonan_ajk_cawangan_config = {
			routes: {
				senarai_permohonan_ajk_cawangan_url: "/rt/sm9/senarai-ajk-cawangan-rt-admin"
			}
		};
		...
		var senarai_ajk_cawangan_table = $('#senarai_ajk_cawangan_table').DataTable( {
			...
			"aoColumnDefs":[{          
				...
				sClass: 'text-center',
                "mRender": function ( value, type, full )  {
                    button_a = '<button type="button" class="btn btn-icon" title="Kemaskini ahli cawangan RT" onclick="view_ajk_cawangan_rt_admin(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					    return button_a;
                }
            }],
            "order": [[ 0, 'asc' ]],
    ...
    function view_ajk_cawangan_rt_admin(id){
		window.location.href = "{{ route('rt-sm9.view_ajk_cawangan_rt_admin','') }}"+"/"+id;
	}
