...
<script type="text/javascript">    
	...
	$(document).ready( function () {
        ...
        /* Maklumat Kawasan Krt */
            $('#macr_ppn_3_nama_krt').html("{{$ajk_cawangan->nama_krt}}");
            $('#macr_ppn_3_alamat_krt').html("{{$ajk_cawangan->alamat_krt}}");
            $('#macr_ppn_3_negeri_krt').html("{{$ajk_cawangan->negeri_krt}}");
            $('#macr_ppn_3_parlimen_krt').html("{{$ajk_cawangan->parlimen_krt}}");
            $('#macr_ppn_3_pbt_krt').html("{{$ajk_cawangan->pbt_krt}}");
            $('#macr_ppn_3_daerah_krt').html("{{$ajk_cawangan->daerah_krt}}");
            $('#macr_ppn_3_dun_krt').html("{{$ajk_cawangan->dun_krt}}");

        /* Maklumat Cawangan RT */
            $('#macr_ppn_3_cawangan_id').val("{{$ajk_cawangan->cawangan_id}}");

        /* Maklumat Status Semakan */
            $('#macr_ppn_3_ajk_cawangan_id').val("{{$ajk_cawangan->id}}");
            $('#macr_ppn_3_diakui_note').on('keyup keypress', function(e) {
        ...
        /* Maklumat Kerjaya */
            $("input[name=macr_ppn_4_status_perkejaan_id][value=" + "{{$ajk_cawangan->status_perkejaan_id}}" + "]").prop('checked', true);
            $('#macr_ppn_4_ajk_pekerjaan_jawatan').val("{{$ajk_cawangan->ajk_pekerjaan_jawatan}}");
            $('#macr_ppn_4_ajk_pekerjaan_bidang').val("{{$ajk_cawangan->ajk_pekerjaan_bidang}}");
            $('#macr_ppn_4_ajk_pekerjaan_pengalaman').val("{{$ajk_cawangan->ajk_pekerjaan_pengalaman}}");
        ...
        /* Maklumat Kemahiran & Hobi */
            $('#macr_ppn_6_ajk_kemahiran').val("{{$ajk_cawangan->ajk_kemahiran}}");
            $('#macr_ppn_6_ajk_minat').val("{{$ajk_cawangan->ajk_minat}}");

        /* Button */
            $('#btn_back').click(function(){
                window.location.href = "{{ route('rt-sm9.memperakui_ajk_cawangan_rt_ppn_1','') }}"+"/"+{{$ajk_cawangan->id}};
            });
