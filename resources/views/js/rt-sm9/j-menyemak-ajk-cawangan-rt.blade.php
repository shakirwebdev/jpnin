...
<script type="text/javascript">    
	...
	$(document).ready( function () {
		...
		var senarai_permohonan_ajk_cawangan_config = {
			routes: {
				senarai_permohonan_ajk_cawangan_url: "/rt/sm9/menyemak-ajk-cawangan-rt"
			}
		};
			...
			"aoColumnDefs":[{          
                ...
                "mRender": function ( value, type, full )  {
                    if (full.ajk_status_form == '4') {
                        button_a = '<button type="button" class="btn btn-icon" title="Kemaskini ahli cawangan RT" onclick="menyemak_ajk_cawangan_rt(\'' + full.id + '\');"><i class="fa fa-edit"></i></button>';
					    return button_a;
                    } else {
                        button_b = '';
                        return button_b;
    ...
    function menyemak_ajk_cawangan_rt(id){
		window.location.href = "{{ route('rt-sm9.menyemak_ajk_cawangan_rt_1_ppd','') }}"+"/"+id;
	}
