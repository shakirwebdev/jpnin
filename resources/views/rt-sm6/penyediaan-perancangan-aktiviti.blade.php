        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm6.borang_perancangan_aktiviti_perpaduan')}}';"><i class="fe fe-plus mr-2"></i>Borang Perancangan Aktiviti Perpaduan</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Penyediaan Perancangan Aktiviti Perpaduan</h3>
                        </div>
...
@include('js.rt-sm6.j-penyediaan-perancangan-aktiviti')
