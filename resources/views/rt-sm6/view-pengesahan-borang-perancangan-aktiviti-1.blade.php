                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group pull-right">
                                                        <button type="submit" class="btn btn-secondary" disabled="">Jana Laporan&nbsp;&nbsp;<i class="dropdown-icon fa fa-print"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row clearfix">
                                                ...
                                                <div class="series-frame">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="" placeholder="Jumlah (Bil. Orang)" disabled="">
                                                        </div>
                                                        <button type="submit" class="btn btn-secondary pull-right" disabled=""><i class="fe fe-plus mr-2"></i>Tambah</button>
                                                    </div>
                                                </div>
                                                <br/><br/>
                                                ...
                                                <div class="series-frame">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="" placeholder="Jumlah" disabled="">
                                                        </div>
                                                        <button type="submit" class="btn btn-secondary pull-right" disabled=""><i class="fe fe-plus mr-2"></i>Tambah</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm6.view_pengesahan_borang_perancangan_aktiviti')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                                <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm6.view_pengesahan_borang_perancangan_aktiviti_2')}}';">Seterusnya&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@include('js.rt-sm6.j-view-pengesahan-borang-perancangan-aktiviti-1')
