...
@section('title', 'Laporan Aktiviti Perpaduan')
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="custom-controls-stacked">
                                                                    ...
                                                                    <label class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" name="plap5_aktiviti_kawasan_DL" value="2" disabled>
...
@include('js.rt-sm6.j-jana-laporan-aktiviti-hq-3')
