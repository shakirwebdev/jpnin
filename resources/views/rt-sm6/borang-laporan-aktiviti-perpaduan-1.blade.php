                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm6.borang_laporan_aktiviti_perpaduan')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                                <button type="button" class="btn btn-secondary"><i class="dropdown-icon fa fa-save"></i>&nbsp;Simpan</button>
                                                <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm6.borang_laporan_aktiviti_perpaduan_2')}}';">Seterusnya&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@include('js.rt-sm6.j-borang-laporan-aktiviti-perpaduan-1')
