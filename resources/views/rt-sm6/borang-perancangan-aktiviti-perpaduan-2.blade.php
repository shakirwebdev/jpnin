                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm6.borang_perancangan_aktiviti_perpaduan_1')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
...
@include('js.rt-sm6.j-borang-perancangan-aktiviti-perpaduan-2')
