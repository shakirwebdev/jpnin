...
@section('title', 'Pengesahan Perancangan Aktiviti Rukun Tertangga')
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="ppapd_krt_id" name="ppapd_krt_id">
...
@include('js.rt-sm6.j-pengesahan-perancangan-aktiviti-ppd')
