...
@section('title', 'Penyediaan Laporan Aktiviti Rukun Tertangga')
...
@section('content')
    ...
    <div class="section-body">
        <form method="POST" action="{{ route('rt-sm6.post_penyediaan_laporan_aktiviti_krt') }}">
        @csrf
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>&nbsp;</div>
                    <div class="header-action">
                        <input type="hidden" name="add_penyediaan_laporan_aktiviti_krt" value="add">
                        <button type="submit" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Tambah Laporan Aktiviti</button>
                    </div>
                </div>
            </div>
        </form>
                ...
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Laporan Aktiviti RT</h3>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_laporan_aktiviti" style="width: 100%">
                                        <thead>
                                            <tr>
...
@include('js.rt-sm6.j-penyediaan-laporan-aktiviti-krt')
