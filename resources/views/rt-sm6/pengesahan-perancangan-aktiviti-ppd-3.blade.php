                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="ppap5_disahkan_by" id="ppap5_disahkan_by">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="1">Disahkan</option>
                                                            <option value="4">Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_ppap5_disahkan_by invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" name="ppap5_disahkan_note" id="ppap5_disahkan_note" rows="4"></textarea>
                                                        <div class="error_ppap5_disahkan_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="ppap5_aktiviti_perancangan_id" id="ppap5_aktiviti_perancangan_id">
                                                            <input type="hidden" name="post_pengesahan_perancangan_aktiviti" value="edit">
                                                            <input type="hidden" name="action" id="post_pengesahan_perancangan_aktiviti" value="edit">
...
@include('js.rt-sm6.j-pengesahan-perancangan-aktiviti-ppd-3')
