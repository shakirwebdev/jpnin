...
@section('title', 'Pengesahan Laporan Aktiviti Rukun Tertangga')
    ...
    <div class="section-body mt-3">
        <div class="container-fluid">
            <div class="tab-content mt-3">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="plapd_krt_id" name="plapd_krt_id">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-primary">Senarai Penyediaan Laporan Aktiviti RT</h3>
                    </div>
...
@include('js.rt-sm6.j-pengesahan-laporan-aktiviti-ppd')
