                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="custom-controls-stacked">
                                                                    ...
                                                                    <label class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" name="ppap5_aktiviti_kawasan_DL" value="2" disabled>
...
@include('js.rt-sm6.j-jana-laporan-perancangan-aktiviti-krt-3')
