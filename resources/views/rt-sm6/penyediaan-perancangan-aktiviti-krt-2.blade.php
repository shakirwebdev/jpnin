                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4">
                                <form method="POST" id="form_ppak2">
                                @csrf
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="row clearfix">
                                                        ...
                                                        <br><br>
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <p><span style="font-size:12px">Nama Kawasan Rukun Tetangga (KRT)</span><br><b><span id="ppak2_nama_krt" name="ppak2_nama_krt"></span></b></p>
                                                            <p><span style="font-size:12px">Alamat Kawasan Rukun Tetangga (KRT)</span><br><b><span id="ppak2_alamat_krt" name="ppak2_alamat_krt"></span></b></p>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <p><span style="font-size:12px">Negeri</span><br><b><span id="ppak2_negeri_krt" name="ppak2_negeri_krt"></span></b></p>
                                                            <p><span style="font-size:12px">Parlimen</span><br><b><span id="ppak2_parlimen_krt" name="ppak2_parlimen_krt"></span></b></p>
                                                            <p><span style="font-size:12px">Pihak Berkuasa Tempatan</span><br><b><span id="ppak2_pbt_krt" name="ppak2_pbt_krt"></span></b></p>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <p><span style="font-size:12px">Daerah</span><br><b><span id="ppak2_daerah_krt" name="ppak2_daerah_krt"></span></b></p>
                                                            <p><span style="font-size:12px">Dun</span><br><b><span id="ppak2_dun_krt" name="ppak2_dun_krt"></span></b></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" id="ppak2_state_id" name="ppak2_state_id" disabled>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" id="ppak2_daerah_id" name="ppak2_daerah_id" disabled>
                                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="ppak2_aktiviti_tempat" id="ppak2_aktiviti_tempat" rows="4" placeholder="Tempat" disabled></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="custom-controls-stacked">
                                                                    <label class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" name="ppak2_aktiviti_kawasan_DL" value="1" disabled>
                                                                        <div class="custom-control-label">Kawasan Rukun Tetangga</div>
                                                                    </label>
                                                                    <label class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" name="ppak2_aktiviti_kawasan_DL" value="2" disabled>
                             ...
                             <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form action="#" id="form_ppak3">
                                            {{ csrf_field() }}
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="col-md-12 alert alert-danger error_form_ppak3" role="alert" style="display: none; padding-bottom: 0px;">
                                                            <ul></ul>
                                                        </div>
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select" id="ppak3_kaum_id" name="ppak3_kaum_id">
                                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select" id="ppak3_jantina_id" name="ppak3_jantina_id">
                                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select" id="ppak3_umur_id" name="ppak3_umur_id">
                                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ppak3_penyertaan_jumlah" id="ppak3_penyertaan_jumlah" placeholder="Jumlah (Bil. Orang)">
                                                                </div>
                                                                <input type="hidden" name="ppak3_aktiviti_perancangan_id" id="ppak3_aktiviti_perancangan_id">
                                                                <input type="hidden" name="add_aktiviti_perancangan_penyertaan" value="add">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form action="#" id="form_ppak4">
                                            {{ csrf_field() }}
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="col-md-12 alert alert-danger error_form_ppak4" role="alert" style="display: none; padding-bottom: 0px;">
                                                            <ul></ul>
                                                        </div>
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select" id="ppak4_rakan_id" name="ppak4_rakan_id">
                                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select" id="ppak4_sumbangan_id" name="ppak4_sumbangan_id">
                                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ppak4_rakan_perpaduan_jumlah" id="ppak4_rakan_perpaduan_jumlah" placeholder="Jumlah">
                                                                </div>
                                                                <input type="hidden" name="ppak4_aktiviti_perancangan_id" id="ppak4_aktiviti_perancangan_id">
                                                                <input type="hidden" name="add_aktiviti_perancangan_rakan_perpaduan" value="add">
...
@include('js.rt-sm6.j-penyediaan-perancangan-aktiviti-krt-2')
