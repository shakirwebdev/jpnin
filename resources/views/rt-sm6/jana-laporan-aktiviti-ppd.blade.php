                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="plap_krt_id" name="plap_krt_id">
                                ...
                                <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_aktiviti" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="background-color: #113f50"><font color="white">Nama Kerja</font></th>
...
@include('js.rt-sm6.j-jana-laporan-aktiviti-ppd')
