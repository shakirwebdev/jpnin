...
@section('title', 'Kelulusan Permohonan Penubuhan Kawasan Rukun Tetangga Baharu')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form action="#" id="form_kpkh5" >
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="kpkh5_krt_status_kelulusan" id="kpkh5_krt_status_kelulusan">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="1">Diluluskan</option>
                                                            <option value="8">Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_kpkh5_krt_status_kelulusan invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="kpkh5_krt_diluluskan_note" id="kpkh5_krt_diluluskan_note"></textarea>
                                                        <div class="error_kpkh5_krt_diluluskan_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="krt_profile_id" id="krt_profile_id">
                                                            <input type="hidden" name="post_kelulusan_permohonan_krt_hq" value="edit">
                                                            <input type="hidden" name="action" id="post_kelulusan_permohonan_krt_hq" value="edit">
...
@include('js.rt-sm1.j-kelulusan-permohonan-krt-hq-5')