                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <input type="hidden" name="kpk2_krt_profileID" id="kpk2_krt_profileID" value="{{$profile_krt->id}}">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm1.kemaskini_profil_krt_1','')}}'+'/'+{{$profile_krt->id}};"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                            <!-- <button type="button" class="btn btn-secondary"><i class="dropdown-icon fa fa-save"></i>&nbsp;Simpan</button> -->
                                            <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm1.kemaskini_profil_krt_3','')}}'+'/'+{{$profile_krt->id}};">Seterusnya&nbsp;&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('js.rt-sm1.j-kemaskini-profil-krt-2')
