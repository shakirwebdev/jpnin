                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_ppk_ppn">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="ppk_ppn_krt_status" id="ppk_ppn_krt_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="6">Disahkan</option>
                                                            <option value="7">Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_ppk_ppn_krt_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" id="ppk_ppn_disahkan_note" name="ppk_ppn_disahkan_note"></textarea>
                                                        <div class="error_ppk_ppn_disahkan_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="ppk_ppn_krt_profile_id" id="ppk_ppn_krt_profile_id">
                                                            <input type="hidden" name="post_pengesahan_permohonan_krt_ppn" value="edit">
                                                            <input type="hidden" name="action" id="post_pengesahan_permohonan_krt_ppn" value="edit">
...
@include('js.rt-sm1.j-pengesahan-permohonan-krt-ppn-5')