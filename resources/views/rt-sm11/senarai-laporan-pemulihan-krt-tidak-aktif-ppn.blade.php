...
@section('title', 'SENARAI LAPORAN TINDAKAN PEMULIHAN KRT TIDAK AKTIF')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <!-- <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm11.add_krt_tidak_aktif')}}';"><i class="fe fe-plus mr-2"></i>Tambah KRT Tidak Aktif</button>
                </div> -->
            </div>
        </div>
    </div>
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI KAWASAN RUKUN TETANGGA TIDAK AKTIF</h3>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_laporan_aktif_koperasi_krt" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Bil</th>
                                                    <th>Nama KRT</th>
                                                    <th>Tempoh Tidak Aktif</th>
                                                    <th>Punca / Sebab<br> Tidak Aktif</th>
                                                    <th>Suku Tahun</th>
                                                    <th>Markah Penilaian Keaktifan %</th>
                                                    <th>Status KRT Terkini</th>
                                                    <th>Cadangan PPD</th>
                                                    <th>Keputusan Mesyuarat Ibu Pejabat</th>
                                                    <th>Tindakan</th>
                                                </tr>
                                            </thead>
                                        </table>
...
@include('js.rt-sm11.j-senarai-laporan-pemulihan-krt-tidak-aktif-ppn')
