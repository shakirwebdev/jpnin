<div class="modal fade" id="modal_jana_sah_keahdiran_peronda" tabindex="-1" role="dialog" aria-labelledby="ModalJPNINLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-xl">
            <div class="modal-header">
                <h5 class="modal-title">Jana Pengesahan Rondaan</h5>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="mb-4">
                            <small>Isi tekan butang dibawah tindakan untuk nama yang hadir untuk rondaan, dan tekan butang Sahkan untuk Pengesahan Kehadiran. 
                            <br>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <label>
                                                    <font color="green"><i class="dropdown-icon fa fa-check"></i></font>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <label>
                                                    <font color="red"><i class="dropdown-icon fa fa-times"></i></font>
                                                </label>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" id="btn-save-jpnin">Jana Pengesahan Rondaan&nbsp;&nbsp;<i class="dropdown-icon fa fa-print"></i></button>
            </div>
        </div>
    </div>
</div>
