<div class="modal fade" id="modal_add_perancangan_rondaan" tabindex="-1" role="dialog" aria-labelledby="ModalJPNINLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Maklumat Perancangan Rondaan</h5>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="" class="form-control" value="" placeholder="Tarikh Rondaan">
