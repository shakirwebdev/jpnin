<!-- The Modal -->
<div class="modal" id="modal_view_dokumen" style="width:50%; height: 650px; margin-left:25%; margin-right:25%; margin-top:1%; margin-bottom:1%; ">
	<div style="width:96%; margin-left:2%; margin-right:2%; margin-top:1%; margin-bottom:1%;">
    	<div class="modal-content" style="width:100%; ">
        	...
        	<div class="modal-body" style="width:100%; height: 350px; overflow:scroll;">
