<div class="modal fade" id="modal_arahan_tindakan_ikes" tabindex="-1" role="dialog" aria-labelledby="ModalJPNINLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Arahan Tindakan Pelaporan i-Kes</h5>
            ...
            @csrf
                <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group">
                                <label class="form-label">Jenis Arahan: <span class="text-red">*</span></label>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="matip_ikes_id" id="matip_ikes_id" >
                    <input type="hidden" name="action" id="post_add_arahan_tindakan_p" value="add">
                    <input type="hidden" name="post_add_arahan_tindakan_p" value="add">
