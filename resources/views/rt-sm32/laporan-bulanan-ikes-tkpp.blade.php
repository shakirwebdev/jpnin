                ...
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Statistik Bulanan i-Kes Mengikut Mengikut Kategori</h3>
                        </div>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="statistik_ikes_kategori" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50" rowspan="2"><label class="form-label text-center"><font color="white">Bulan</font></label></th>
...
@include('js.rt-sm32.j-laporan-bulanan-ikes-tkpp')