                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="laporan_kluster_ikes" style="width: 3000px">
                                        <thead>
                                            <tr>
...
@include('js.rt-sm32.j-laporan-ikes-kluster-ppn')