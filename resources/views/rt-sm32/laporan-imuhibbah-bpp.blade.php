        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="libp_state_id" name="libp_state_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="libp_daerah_id" name="libp_daerah_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Laporan i-Ramal</h3>
                        </div>
...
@include('js.rt-sm32.j-laporan-imuhibbah-bpp')