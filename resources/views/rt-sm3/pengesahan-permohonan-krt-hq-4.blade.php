...
02000 Kuala Perlis, Perlis
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <h6><b>SENARAI JAWATANKUASA PENAJA RUKUN TETANGGA</b></h6>
                                            <br>
                                            <p>Senarai Nama</p>
                                            <hr class="mt-1">
                                            <div class="row clearfix">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="table-responsive">
                                                        <table class="table thead-dark table-bordered table-striped" id="penaja_table" style="width: 100%" border="1">
                                                            <thead>
                                                                <tr>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <br><br>
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm3.pengesahan_permohonan_krt_hq_3')}}';">Kembali</button>&nbsp;
                                                <button type="submit" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm3.pengesahan_permohonan_krt_hq_5')}}';">Seterusnya</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@include('js.rt-sm3.j-semakan-permohonan-krt-ppd-4')