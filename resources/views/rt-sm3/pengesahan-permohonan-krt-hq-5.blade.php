                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="" class="form-control" value="22:45" placeholder="Masa" disabled="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="" value="Balai Raya Taman Peladang Jaya" disabled="">
                                                    </div>
                                                    <div class="form-group">
                                                            ...
                                                            <table class="table thead-dark table-bordered table-striped" id="senarai_kehadiran_table" style="width: 100%" border="1">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="40%"><label class="form-label"><font color="#113f50">Nama</font></label></th>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label">1.Ucapan Pengerusi Majlis : </label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">2.Ucapan Pemimpin Masyarakat : </label>
                                                            <div class="series-frame">
                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">3.Penerangan dan Cadangan Persempadanan Kawasan Rukun Tetangga : </label>
                                                            <div class="table-responsive">
                                                                <table class="table thead-dark table-bordered table-striped" id="cadangan_sempadan_table" style="width: 100%" border="1">
                                                                    <thead>
                                                                        <tr>
                                                                            <th width="10%"><label class="form-label"><font color="#113f50">Bil</font></label></th>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <br><br>
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm3.pengesahan_permohonan_krt_hq_4')}}';">Kembali</button>&nbsp;
                                                <button type="submit" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm3.pengesahan_permohonan_krt_hq_6')}}';">Seterusnya</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@include('js.rt-sm3.j-semakan-permohonan-krt-ppd-5')