...
@section('title', 'Permohonan Pelaporan Insiden')
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="" placeholder="Tajuk">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="" id="" placeholder="Tarikh Laporan" data-date-format="dd/mm/yyyy">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="" name="" rows="5" placeholder="Tempat">
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="pma_laporan" id="pma_laporan" ></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Sumber Maklumat: <span class="text-red">*</span></label>
                                                            <textarea class="form-control" name="pma_sumber_maklumat" id="pma_sumber_maklumat" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label">Tempat: <span class="text-red">*</span></label>
                                                            <textarea class="form-control" id="" name="" rows="5" placeholder="Tempat" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@include('js.rt-sm22.j-permohonan-muhibbah-admin-1')
