...
@section('content')
    ...
    <div class="section-body">
        <form method="POST" action="{{ route('rt-sm9.post_tambah_ajk_cawangan_rt') }}">
        @csrf
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>&nbsp;</div>
                    <div class="header-action">
                        <input type="hidden" name="add_tambah_ajk_cawangan_rt" value="add">
                        <button type="submit" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Tambah Ajk Cawangan</button>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <label class="form-label">Nama Cawangan RT</label>
                                    <div class="form-group">
                                        <select class="custom-select" id="tacrt_cawangan_id" name="tacrt_cawangan_id">
...
@include('js.rt-sm9.j-tambah-ajk-cawangan-rt')
