...
@section('title', 'Memperakui Ahli Cawangan RT')
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="macrt_cawangan_id" name="macrt_cawangan_id">
...
@include('js.rt-sm9.j-memperakui-ajk-cawangan-rt-ppn')
