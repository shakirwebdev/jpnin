...
@include('modal.modal-pilih-ajk-krt')
                                            ...
                                            <div class="row clearfix">
												...
												<div class="col-lg-6 col-md-4 col-sm-4">
													<div class="form-group">
														<input type="hidden" id="wujud_status" value="0">
                                                        <label class="form-label">Penggal : <span class="text-red">*</span></label>
                                                        <select class="form-control" name="bpe_ajk_penggal" id="bpe_ajk_penggal">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            @foreach($ref_penggal as $item)                                    
                                                                <option value="{{ $item->id }}">{{ $item->penggal_mula }}/{{ $item->penggal_tamat }}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="error_bpe_ajk_penggal invalid-feedback text-right"></div>
                                                    </div>
												</div>
												<div class="col-lg-6 col-md-4 col-sm-4">
													<div class="form-group">
                                                        <label class="form-label">No Kad Pengenalan: <span class="text-red">*</span></label>
														<input type="hidden" id="dahchange" name="dahchange" value="1">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly class="form-control" name="bpe_ajk_tarikh_lahir" id="bpe_ajk_tarikh_lahir" placeholder="Tarikh Lahir" data-date-format="dd/mm/yyyy">
                                                    ...
                                                    <div class="form-group">
														...
														<input type="text" readonly class="form-control" name="bpe_ajk_k_umur" id="bpe_ajk_k_umur" placeholder="Umur">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="error_bpe_ajk_poskod invalid-feedback text-right">tetette</div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
