        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm4.borang_pendaftaran_rt_b1')}}';"><i class="fe fe-plus mr-2"></i>Cadangan AJK Berkepentingan Dikawasan RT</button>
                </div>
            </div>
        </div>
    </div>
...
@include('js.rt-sm4.j-cadangan-ajk-kepentingan-krt')
