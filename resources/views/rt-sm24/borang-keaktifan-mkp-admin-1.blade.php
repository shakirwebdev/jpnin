                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <br>
                                            <p>3. Latihan / Kursus Pembangunan Diri: <span class="text-red">*</span></p>
                                            <hr class="mt-1">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Nama Latihan / Kursus">
                                                                </div>
                                                                <div class="form-group">
                                                                    <b>Tarikh: </b>
                                            ...
                                            <p>4. Sumbangan Dan Pengiktirafan: <span class="text-red">*</span></p>
                                            <hr class="mt-1">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Sumbangan / Pengiktirafan">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="form-label">Peringkat: </label>
                                                                    <select class="select2 custom-select" id="" name="">
...
@include('js.rt-sm24.j-borang-keaktifan-mkp-admin-1')
