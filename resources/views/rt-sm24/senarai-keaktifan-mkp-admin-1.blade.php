...
@section('title', 'Paparan Penilaian Keaktifan Mediator Komuniti')
                                                        ...
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Nama Aktiviti / Program" disabled>
                                                                </div>
                                                                <div class="form-group">
                                                                    <b>Tarikh: </b>
...
@include('js.rt-sm24.j-senarai-keaktifan-mkp-admin-1')
