                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table thead-dark table-bordered table-striped" id="senarai_jenis_pertubuhan_table" style="width: 100%" border="1">
                                                            <thead>
                                                                <tr>
                                                                    <th style="background-color: #113f50" ><font color="white">Bil</font></th>
                                                                    <th style="background-color: #113f50" ><font color="white">Pertubuhan</font></th>
                                                                    <th style="background-color: #113f50" ><font color="white">Tindakan</font></th>
                                                                </tr>
                                                            </thead>
                                                            <input type="hidden" name="pk6_krt_profileID" id="pk6_krt_profileID">
                                                        </table>
                                                    </div>
                                                    <br>
                                                </div>
...
@include('js.rt-sm2.j-profile-krt-2')
