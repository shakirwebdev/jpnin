...
@section('title', 'Laporan Bagunan Tumpang Dalam Kawasan RT')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Bagunan Tumpang Ada Dalam Kawasan RT'</h3>
                        </div>
...
@include('js.rt-sm30.j-laporan-binaan-tumpang-rt-hqrt')