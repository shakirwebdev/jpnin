...
@section('title', 'Laporan AJK Mengikut Kaum')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakpn_daerah_id" name="lakpn_daerah_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakpn_krt_id" name="lakpn_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Laporan AJK Mengikut Kaum</h3>
                        </div>
...
@include('js.rt-sm30.j-laporan-ajk-kaum-ppn')