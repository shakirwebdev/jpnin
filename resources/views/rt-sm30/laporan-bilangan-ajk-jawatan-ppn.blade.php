                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajpn_daerah_id" name="lbajpn_daerah_id">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajpn_parlimen_id" name="lbajpn_parlimen_id" >
                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajpn_dun_id" name="lbajpn_dun_id" disabled>
                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                </select>
                                            </div>
                                        </div>
...
@include('js.rt-sm30.j-laporan-bilangan-ajk-jawatan-ppn')