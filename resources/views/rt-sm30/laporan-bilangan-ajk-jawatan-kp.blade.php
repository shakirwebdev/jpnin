                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajkp_state_id" name="lbajkp_state_id">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajkp_daerah_id" name="lbajkp_daerah_id" disabled>
                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajkp_parlimen_id" name="lbajkp_parlimen_id" disabled>
                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <select class="custom-select" id="lbajkp_dun_id" name="lbajkp_dun_id" disabled>
                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                </select>
                                            </div>
                                        </div>
...
@include('js.rt-sm30.j-laporan-bilangan-ajk-jawatan-kp')