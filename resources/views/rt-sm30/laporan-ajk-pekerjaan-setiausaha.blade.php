...
@section('title', 'Laporan Bilangan AJK Mengikut Pekerjaan')
                ...
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Bilangan AJK Mengikut Pekerjaan</h3>
                        </div>
...
@include('js.rt-sm30.j-laporan-ajk-pekerjaan-setiausaha')