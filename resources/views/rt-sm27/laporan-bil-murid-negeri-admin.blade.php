...
@section('title', 'Laporan Bilangan Murid Tabika Perpaduan Ikut Negeri')
                                ...
                                <table class="table table-striped table-vcenter table-hover mb-0" id="list_bil_murid" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="background-color: #113f50" ><font color="white">Bilangan</font></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
@include('js.rt-sm27.j-laporan-bil-murid-negeri-admin')