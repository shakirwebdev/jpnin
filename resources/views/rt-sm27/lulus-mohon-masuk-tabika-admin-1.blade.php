...
@section('title', 'Kelulusan Kemasukan Tabika Perpaduan')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group pull-right">
                                                    <button type="submit" class="btn btn-primary">Hantar Status Kelulusan&nbsp;&nbsp;<i class="dropdown-icon fa fa-paper-plane"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@include('js.rt-sm27.j-lulus-mohon-masuk-tabika-admin-1')