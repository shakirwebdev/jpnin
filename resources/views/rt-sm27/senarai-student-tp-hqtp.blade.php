...
@section('title', 'Semakan Status Permohonan')
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="ssthqtp_state_id" name="ssthqtp_state_id" >
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <div class="form-group">
                                    <select class="custom-select" id="ssthqtp_daerah_id" name="ssthqtp_daerah_id" disabled>
                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <label class="form-label">Senarai Tabika</label>
                                <div class="form-group">
                                    <select class="custom-select" id="ssthqtp_tabika_id" name="ssthqtp_tabika_id" disabled>
                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-header">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h3 class="card-title text-primary">
                                Senarai Status Permohonan Kemasukan Pelajar Ke Tabika Perpaduan
                            </h3>
                        </div>
                    </div>
...
@include('js.rt-sm27.j-senarai-student-tp-hqtp')