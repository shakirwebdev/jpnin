                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="stpd_ibu_nama" id="stpd_ibu_nama" placeholder="Nama" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Pekerjaan: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_pekerjaan" id="stpd_ibu_pekerjaan" placeholder="Pekerjaan" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Sektor Pekerjaan: </label>
                                                        <select class="form-control" name="stpd_ibu_profession_id" id="stpd_ibu_profession_id" disabled>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="stpd_ibu_pendapatan" id="stpd_ibu_pendapatan" placeholder="Pendapatan Bulanan" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Kerakyatan: </label>
                                                        <select class="form-control" name="stpd_ibu_kerakyatan_id" id="stpd_ibu_kerakyatan_id" disabled>
                                                            <option value="" selected style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="stpd_ibu_jumlah_pendapatan" id="stpd_ibu_jumlah_pendapatan" placeholder="Jumlah Pendapatan Bulanan" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Jumlah Pendapatan Lain (RM): <span class="text-red">(sekiranya ada)</span></label>
                                                        <input type="text" class="form-control" name="stpd_ibu_jumlah_pendapatan_lain" id="stpd_ibu_jumlah_pendapatan_lain" placeholder="Jumlah Pendapatan Lain" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <label class="form-label">No Kad Pengenalan: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_ic" id="stpd_ibu_ic" placeholder="No Kad Pengenalan" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Alamat Tempat Kerja: </label>
                                                        <textarea class="form-control" rows="5" name="stpd_ibu_alamat_office" id="stpd_ibu_alamat_office" placeholder="Alamat Tempat Kerja" disabled></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">No Telefon Pejabat: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_phone_office" id="stpd_ibu_phone_office" placeholder="No Telefon Pejabat" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">No Telefon Bimbit: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_phone" id="stpd_ibu_phone" placeholder="No Telefon Bimbit" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">No Telefon Rumah: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_phone_rumah" id="stpd_ibu_phone_rumah" placeholder="No Telefon Rumah" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Bilangan Anak: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_bil_anak" id="stpd_ibu_bil_anak" placeholder="Bilangan Anak" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Hubungan Dengan Murid: </label>
                                                        <input type="text" class="form-control" name="stpd_ibu_hubungan_student" id="stpd_ibu_hubungan_student" placeholder="Hubungan Dengan Murid" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Tabika Perpaduan Adalah Pilihan yang Kebarapa ? : </label>
                                                        <select class="form-control" name="stpd_ibu_pilihan" id="stpd_ibu_pilihan" disabled>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="stpd_ibu_bil_anak_sekolah" id="stpd_ibu_bil_anak_sekolah" placeholder="Bilangan Anak Bersekolah" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Nama Tabika Lain Yang Dipohon: <span class="text-red">(jika ada)</span></label>
                                                        <input type="text" class="form-control" name="stpd_ibu_tabika_lain" id="stpd_ibu_tabika_lain" placeholder="Nama Tabika Lain Yang Dipohon" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row clearfix">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <table class="table thead-dark table-bordered table-striped" id="senarai_pengesahan_penjaga_table" style="width: 100%" border="0">
                                                            <input type="hidden" name="stpd_1_student_id" id="stpd_1_student_id">
                                                            <tbody></tbody>
                                                        </table>
                                                    </div>
                                                </div>
...
@include('js.rt-sm27.j-student-tp-ppd-1')