...
@section('title', 'Papar Minit Mesyuarat Jawatankuasa')
            ...
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">Senarai Minit Mesyuarat Jawatankuasa</h3>
                            </div>
...
@include('js.rt-sm5.j-paparan-minit-mesyuarat-rt-ppd')