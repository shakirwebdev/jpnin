                                        ...
                                        @csrf
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary pull-right" onclick="load_add_kehadiran_mesyuarat_krt();"><i class="fe fe-plus mr-2"></i>Tambah</button>
                                                        <br>
                                                        <br>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">2. Pengesahan Minit mensyurat Yang Lalu: <label><font color="red">*</font></label> </label>
