                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
														...
														<table class="table" id="senarai_kehadiran_ajk_table" name="senarai_kehadiran_ajk_table" style="width: 100%">
																	<thead>
																		<tr>
																			...
																			<th style="background-color: #113f50; display:none;" align="center"><font color="white">Jawatan ID</font></th>
                                                                        </tr>
																	</thead>
																</table>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="pmmrp_pengerusi_mesyuarat" id="pmmrp_pengerusi_mesyuarat" placeholder="Dipengerusikan oleh" disabled>
                                                    </div>
													<div class="form-group">
                                                        <label class="form-label">Dicatat oleh: </label>
														<input type="text" class="form-control" name="pmmrp_catat_mesyuarat" id="pmmrp_catat_mesyuarat" placeholder="Dicatat oleh" disabled>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
