                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="apspn_daerah_id" id="apspn_daerah_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="apspn_krt_id" id="apspn_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_ahli_peronda_srs_table" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><font color="white">Nama Daerah</font></th>
...
@include('js.rt-sm13.j-senarai-ahli-peronda-srs-ppn')
