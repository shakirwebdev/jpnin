        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm19.borang_pembatalan_srs')}}';"><i class="fe fe-plus mr-2"></i>Permohonan Pembatalan SRS</button>
                </div>
            </div>
        </div>
    </div>
...
@include('js.rt-sm19.j-permohonan-pembatalan-srs')