...
@section('title', 'Semakan Borang Permohonan Pembatalan Skim Rondaan Sukarela (SRS)')
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group pull-right">
                                                        <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm19.semakan_permohonan_pembatalan_srs')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
