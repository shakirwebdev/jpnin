                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ppspn_daerah_id" id="ppspn_daerah_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ppspn_krt_profile_id" id="ppspn_krt_profile_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ppspn_srs_profile_id" id="ppspn_srs_profile_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_permohonan_penarikan_diri" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><font color="white">Dimohon Oleh</font></th>
...
@include('js.rt-sm19.j-pengesahan-pembatalan-srs-ppn')