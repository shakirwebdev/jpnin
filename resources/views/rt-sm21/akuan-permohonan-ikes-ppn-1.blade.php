...
@section('title', 'Memperakukan Permohonan Pelaporan i-Kes')
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="apipn1_hasRT" id="apipn1_hasRT" class="custom-switch-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="apipn1_krt_profile_id" id="apipn1_krt_profile_id" disabled>
                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                        @foreach($krt as $item)                                    
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="apipn1_user_fullname" id="apipn1_user_fullname" placeholder="Nama Pemohon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Kad Pengenalan: </label>
                                                    <input type="text" class="form-control" name="apipn1_user_no_ic" id="apipn1_user_no_ic" placeholder="No Kad Pengenalan" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Telefon: </label>
                                                    <input type="text" class="form-control" name="apipn1_user_no_phone" id="apipn1_user_no_phone" placeholder="No Telefon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Alamat: </label>
                                                    <textarea class="form-control" id="apipn1_dihantar_alamat" name="apipn1_dihantar_alamat" rows="4" disabled="" placeholder="Alamat"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="apipn1_ikes_bil_terlibat" id="apipn1_ikes_bil_terlibat" placeholder="Bilangan Terlibat" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Antara Etnik: </label>
                                                            <select class="form-control" name="apipn1_status_etnik_id" id="apipn1_status_etnik_id" disabled>
                                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="apipn1_status_warganegara_id" id="apipn1_status_warganegara_id" disabled>
                                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                    ...
                                                    <br><br>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="apipn1_ikes_bil_tangkapan" id="apipn1_ikes_bil_tangkapan" placeholder="Bilangan Tangkapan Polis" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@include('js.rt-sm21.j-akuan-permohonan-ikes-ppn-1')
