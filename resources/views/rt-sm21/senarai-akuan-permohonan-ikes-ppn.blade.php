...
@section('title', 'Memperakukan Permohonanan Pelaporan i-Kes')
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="sapipn_daerah_id" name="sapipn_daerah_id">
...
@include('js.rt-sm21.j-senarai-akuan-permohonan-ikes-ppn')