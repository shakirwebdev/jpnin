...
@section('title', 'Arahan Tindakan i-Kes')


@section('content')
@include('modal.modal-arahan-tindakan-ikes')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="saip_state_id" name="saip_state_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                       <select class="custom-select" id="saip_daerah_id" name="saip_daerah_id" disabled>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Pelaporan i-Kes</h3>
                        </div>
...
@include('js.rt-sm21.j-senarai-at-ikes-p')