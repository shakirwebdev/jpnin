                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            <label class="custom-switch">
                                                                <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input">
                                                                <span class="custom-switch-indicator"></span>
                                                                <span class="custom-switch-description">Ada Tindakan Kes Kejadian</span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Bentuk Tindakan: <span class="text-red">*</span></label>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">Pihak Yang Terlibat: <span class="text-red">*</span></label>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="table-responsive">
...
@include('js.rt-sm21.j-permohonan-insiden-admin-2')
