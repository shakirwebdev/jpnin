...
@include('modal.modal-add-bilangan-kematian')
    ...
    <div class="section-body mt-3" style="display:none;" id="pi4_perlu_kemaskini">
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="mb-4">
                        <div class="alert alert-warning alert-dismissible fade show small" role="alert" >
                            <div class="mb-10">
                                ...
                                <span class="text-red blink" id="pi4_status_description" name="pi4_status_description"></span></b>
                                <br><br>
                                <code><span style="text-size: 16px;"><strong>Note:</strong></span></code> 
                                <span id="pi4_diakui_note" name="pi4_diakui_note"></span></span>
                                <span id="pi4_disemak_note" name="pi4_disemak_note"></span></span>
                                <span id="pi4_disahkan_note" name="pi4_disahkan_note"></span></span>.
                                <br>
                                <input type="hidden" name="pi4_status" id="pi4_status">
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="pi4_hasRT" id="pi4_hasRT" class="custom-switch-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pi4_negeri_id" id="pi4_negeri_id" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pi4_daerah_id" id="pi4_daerah_id" disabled>
                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pi4_krt_profile_id" id="pi4_krt_profile_id" disabled>
                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                        @foreach($krt as $item)                                    
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pi4_user_fullname" id="pi4_user_fullname" placeholder="Nama Pemohon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Kad Pengenalan: </label>
                                                    <input type="text" class="form-control" name="pi4_user_no_ic" id="pi4_user_no_ic" placeholder="No Kad Pengenalan" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Telefon: </label>
                                                    <input type="text" class="form-control" name="pi4_user_no_phone" id="pi4_user_no_phone" placeholder="No Telefon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Alamat Pejabat: </label>
                                                    <textarea class="form-control" id="pi4_dihantar_alamat" name="pi4_dihantar_alamat" rows="4" disabled="" placeholder="Alamat"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <hr class="mt-1">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <form method="POST" id="form_pi4">
                                                @csrf
                                                    <div class="row clearfix">
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Bilangan Terlibat: <span class="text-red">*</span></label>
                                                                <input type="text" class="form-control" name="pi4_ikes_bil_terlibat" id="pi4_ikes_bil_terlibat" placeholder="Bilangan Terlibat">
                                                                <div class="error_pi4_ikes_bil_terlibat invalid-feedback text-right"></div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Antara Etnik: <span class="text-red">*</span></label>
                                                                <select class="form-control" name="pi4_status_etnik_id" id="pi4_status_etnik_id">
                                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                    @foreach($status_etnik as $item)                                    
                                                                        <option value="{{ $item->id }}">{{ $item->status_etnik_description }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="error_pi4_status_etnik_id invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Pilihan Warganegara: <span class="text-red">*</span></label>
                                                                <select class="form-control" name="pi4_status_warganegara_id" id="pi4_status_warganegara_id">
                                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                    @foreach($status_warganegara as $item)                                    
                                                                        <option value="{{ $item->id }}">{{ $item->warganegara_description }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="error_pi4_status_warganegara_id invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pi4_ikes_bil_tangkapan" id="pi4_ikes_bil_tangkapan" placeholder="Bilangan Tangkapan Polis">
                                                                <div class="error_pi4_ikes_bil_tangkapan invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form method="POST" id="form_pi5">
                                            @csrf
                                                <input type="hidden" name="pi5_ikes_id" id="pi5_ikes_id">
                                                <input type="hidden" name="post_permohonan_ikes_2" value="edit">
                                                <input type="hidden" name="action" id="post_permohonan_ikes_2" value="edit">
...
@include('js.rt-sm21.j-permohonan-ikes-1')
