...
@include('modal.modal-add-bilangan-kematian')
    ...
    <div class="section-body mt-3" style="display:none;" id="pipp4_perlu_kemaskini">
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="mb-4">
                        <div class="alert alert-warning alert-dismissible fade show small" role="alert" >
                            <div class="mb-10">
                                ...
                                <span class="text-red blink" id="pipp4_status_description" name="pipp4_status_description"></span></b>
                                <br><br>
                                <code><span style="text-size: 16px;"><strong>Note:</strong></span></code> 
                                <span id="pipp4_diakui_note" name="pipp4_diakui_note"></span></span>
                                <span id="pipp4_disemak_note" name="pipp4_disemak_note"></span></span>
                                <span id="pipp4_disahkan_note" name="pipp4_disahkan_note"></span></span>.
                                <br>
                                <input type="hidden" name="pipp4_status" id="pipp4_status">
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="pipp4_hasRT" id="pipp4_hasRT" class="custom-switch-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pipp4_negeri_id" id="pipp4_negeri_id" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pipp4_daerah_id" id="pipp4_daerah_id" disabled>
                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pipp4_krt_profile_id" id="pipp4_krt_profile_id" disabled>
                                                        <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                        @foreach($krt as $item)                                    
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pipp4_user_fullname" id="pipp4_user_fullname" placeholder="Nama Pemohon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Kad Pengenalan: </label>
                                                    <input type="text" class="form-control" name="pipp4_user_no_ic" id="pipp4_user_no_ic" placeholder="No Kad Pengenalan" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">No Telefon: </label>
                                                    <input type="text" class="form-control" name="pipp4_user_no_phone" id="pipp4_user_no_phone" placeholder="No Telefon" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Alamat: </label>
                                                    <textarea class="form-control" id="pipp4_dihantar_alamat" name="pipp4_dihantar_alamat" rows="4" disabled="" placeholder="Alamat"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <hr class="mt-1">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <form method="POST" id="form_pipp4">
                                                @csrf
                                                    <div class="row clearfix">
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Bilangan Terlibat: <span class="text-red">*</span></label>
                                                                <input type="text" class="form-control" name="pipp4_ikes_bil_terlibat" id="pipp4_ikes_bil_terlibat" placeholder="Bilangan Terlibat">
                                                                <div class="error_pipp4_ikes_bil_terlibat invalid-feedback text-right"></div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Antara Etnik: <span class="text-red">*</span></label>
                                                                <select class="form-control" name="pipp4_status_etnik_id" id="pipp4_status_etnik_id">
                                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                    @foreach($status_etnik as $item)                                    
                                                                        <option value="{{ $item->id }}">{{ $item->status_etnik_description }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="error_pipp4_status_etnik_id invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Pilihan Warganegara: <span class="text-red">*</span></label>
                                                                <select class="form-control" name="pipp4_status_warganegara_id" id="pipp4_status_warganegara_id">
                                                                    <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                                    @foreach($status_warganegara as $item)                                    
                                                                        <option value="{{ $item->id }}">{{ $item->warganegara_description }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="error_pipp4_status_warganegara_id invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pipp4_ikes_bil_tangkapan" id="pipp4_ikes_bil_tangkapan" placeholder="Bilangan Tangkapan Polis">
                                                                <div class="error_pipp4_ikes_bil_tangkapan invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form method="POST" id="form_pipp5">
                                            @csrf
                                                <input type="hidden" name="pipp5_ikes_id" id="pipp5_ikes_id">
                                                <input type="hidden" name="post_permohonan_ikes_bpp_2" value="edit">
                                                <input type="hidden" name="action" id="post_permohonan_ikes_bpp_2" value="edit">
...
@include('js.rt-sm21.j-permohonan-ikes-bpp-1')
