...
@section('title', 'Pengesahan Permohonanan Pelaporan i-Kes')
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="sspip_state_id" name="sspip_state_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="sspip_daerah_id" name="sspip_daerah_id" disabled>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_permohonan_pelaporan_kes" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50" ><label class="form-label"><font color="white">Negeri</th></font></label></th>
...
@include('js.rt-sm21.j-senarai-sahkan-permohonan-ikes-p')