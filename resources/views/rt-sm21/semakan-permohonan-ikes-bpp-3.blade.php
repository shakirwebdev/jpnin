                                            ...
                                            <div class="col-12">
                                                ...
                                                @csrf
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control semak_status_ppd" name="apipn3_ikes_status" id="apipn3_ikes_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="6">Disemak</option>
                                                            <option value="7">Perlu Dikemaskini</option>
                                                        </select>
                                                        <select class="form-control semak_status_ppn" name="apipn3_ikes_status" id="apipn3_ikes_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="apipn3_disemak_note" id="apipn3_disemak_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_apipn3_disemak_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="apipn3_spk_ikes_id" id="apipn3_spk_ikes_id">
                                                            <input type="hidden" name="post_semakan_permohonan_ikes" value="edit">
                                                            <input type="hidden" name="action" id="post_semakan_permohonan_ikes" value="edit">
...
@include('js.rt-sm21.j-semakan-permohonan-ikes-bpp-3')
