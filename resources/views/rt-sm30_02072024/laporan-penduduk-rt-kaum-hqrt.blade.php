...
@section('title', 'Laporan RT Mengikut Kaum')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Laporan RT Mengikut Kaum</h3>
                        </div>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="bilangan_penduduk_mengikut_kaum" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><font color="white">Bumiputra Sabah</font></th>
                                                <th style="background-color: #113f50"><font color="white">Bumiputra Serawak</font></th>
...
@include('js.rt-sm30.j-laporan-penduduk-rt-kaum-hqrt')