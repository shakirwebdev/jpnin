...
@section('title', 'Laporan AJK Mengikut Pendidikan')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Laporan AJK Mengikut Pendidikan</h3>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_ajk_pendidikan" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><label class="form-label"><font color="white">Senarai Pendidikan</font></label></th>
...
@include('js.rt-sm30.j-laporan-ajk-pendidikan-ppn')