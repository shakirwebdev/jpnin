                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakupn_daerah_id" name="lakupn_daerah_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakupn_parlimen_id" name="lakupn_parlimen_id">
                                            <option value="" selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakupn_dun_id" name="lakupn_dun_id" disabled>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakupn_krt_id" name="lakupn_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakupn_k_umur_id" name="lakupn_k_umur_id">
                                            <option value="" selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
...
@include('js.rt-sm30.j-laporan-ajk-krt-umur-ppn')