...
@section('title', 'Laporan Kekerapan Mesyuarat RT')
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="laporan_binaan_tumpang_rt" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50" ><font color="white">Tempat</font></th>
                                                <th style="background-color: #113f50" ><font color="white">Pengerusi</font></th>
                                                <th style="background-color: #113f50" ><font color="white">Bil Kehadiran</font></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
...
@include('js.rt-sm30.j-laporan-kekerapan-mesyuarat-rt-hqrt')