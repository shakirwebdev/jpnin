...
@section('title', 'Laporan AJK Mengikut Jantina')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lajhq_state_id" name="lajhq_state_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lajhq_daerah_id" name="lajhq_daerah_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lajhq_krt_id" name="lajhq_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Laporan AJK Mengikut Jantina</h3>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_ajk_jantina" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><label class="form-label"><font color="white">Senarai Jantina</font></label></th>
...
@include('js.rt-sm30.j-laporan-ajk-jantina-hqrt')