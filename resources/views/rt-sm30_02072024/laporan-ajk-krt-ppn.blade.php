                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_daerah_id" name="lakppn_daerah_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_parlimen_id" name="lakppn_parlimen_id">
                                            <option value="" selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_dun_id" name="lakppn_dun_id" disabled>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_krt_id" name="lakppn_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_kaum_id" name="lakppn_kaum_id" >
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_pendidikan_id" name="lakppn_pendidikan_id" >
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lakppn_jawatan_id" name="lakppn_jawatan_id" >
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
...
@include('js.rt-sm30.j-laporan-ajk-krt-ppn')