                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="srkr_tarikh_t_b" id="srkr_tarikh_t_b" placeholder="Tarikh Penerimaan / Pembayaran" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">No Cek / No Baucer:</label>
                                                            <input type="text" class="form-control" name="srkr_kewangan_cek_baucer" id="srkr_kewangan_cek_baucer" placeholder="No Cek / No Baucer" disabled="">
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="srkr_tarikh_c_b" id="srkr_tarikh_c_b" placeholder="Tarikh Cek / Tarikh Baucer" value="01/01/2020" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <b>Jumlah</b>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="srkr_kewangan_jumlah_tunai" id="srkr_kewangan_jumlah_tunai" placeholder="Tunai" disabled="">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="srkr_kewangan_jumlah_bank" id="srkr_kewangan_jumlah_bank" placeholder="Bank" disabled="">
                                                                <div class="c_username invalid-feedback text-right"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
