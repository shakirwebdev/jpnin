                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ppps_daerah_id" id="ppps_daerah_id">
                                        ...
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_permohonan_penubuhan_srs" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #113f50"><font color="white">No SRS</font></th>
...
@include('js.rt-sm12.j-pengesahan-permohonan-penubuhan-srs')
