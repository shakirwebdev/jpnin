                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control" name="krkr_kewangan_jumlah_tunai" id="krkr_kewangan_jumlah_tunai" placeholder="Tunai" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control" name="krkr_kewangan_jumlah_bank" id="krkr_kewangan_jumlah_bank" placeholder="Bank" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)">
