...
@section('title', 'Lihat Semakan Rekod Penerimaan & Pengeluaran Kewangan')
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="krkr_kewangan_jenis_kewangan" id="krkr_kewangan_jenis_kewangan" disabled>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6" style="border:1px solid;">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="krkr_kewangan_nama_penuh" id="krkr_kewangan_nama_penuh" placeholder="Nama Penuh" disabled>
                                                                <div class="error_krkr_kewangan_nama_penuh invalid-feedback text-right"></div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Alamat: </label>
                                                                <textarea class="form-control" name="krkr_kewangan_alamat" id="krkr_kewangan_alamat" rows="6" placeholder="Alamat" disabled></textarea>
                                                            ...
                                                            <div class="series-frame">
                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="krkr_kewangan_butiran" id="krkr_kewangan_butiran" placeholder="Butiran" disabled>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="krkr_kewangan_tarikh_t_b" id="krkr_kewangan_tarikh_t_b" placeholder="Tarikh Penerimaan / Pembayaran" data-date-format="dd/mm/yyyy" disabled>
																	...
																	<div class="form-group">
																		...
																		<div class="input-group mb-3">
																			...
																			<input type="text" class="form-control time24" name="krkr_kewangan_time_t_b" id="krkr_kewangan_time_t_b" placeholder="Masa" disabled>
																	...
																	{{ csrf_field() }}
																	<div class="form-group border border-info pl-4 pt-2 pr-4 pb-2" style="display:none;">
																			...
																			<br>
                                                                            <label class="form-label">No Cek / No Baucer / No Resit:</label>
                                                                        ...
                                                                        <br>
                                                                        <b>Tarikh Cek / Tarikh Baucer / Tarikh Resit:</b>
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend">
                                                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control" name="krkr_kewangan_jumlah_tunai" id="krkr_kewangan_jumlah_tunai" placeholder="Tunai" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" disabled>
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control" name="krkr_kewangan_jumlah_bank" id="krkr_kewangan_jumlah_bank" placeholder="Bank" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" disabled>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <button style="display:none;" type="submit" class="btn btn-primary" id="btn_send">Hantar Maklumat Kewangan&nbsp;&nbsp;<i class="dropdown-icon fa fa-paper-plane"></i></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
@include('js.rt-sm7.j-lihatsemakan-rekod-kewangan-rt-1')
