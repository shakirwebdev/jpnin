                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control" name="arkr_kewangan_jumlah_tunai" id="arkr_kewangan_jumlah_tunai" placeholder="cth : 0.00" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control" name="arkr_kewangan_jumlah_bank" id="arkr_kewangan_jumlah_bank" placeholder="cth : 0.00" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)">
