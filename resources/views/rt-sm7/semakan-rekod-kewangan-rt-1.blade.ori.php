                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="srkr_kewangan_tarikh_c_b" id="srkr_kewangan_tarikh_c_b" placeholder="Tarikh Cek / Tarikh Baucer" value="01/01/2020" disabled="">
                                                            </div>
                                                        </div>
														<div class="form-group">
