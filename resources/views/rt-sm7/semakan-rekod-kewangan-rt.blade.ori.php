            ...
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
					...
					<div class="tab-pane fade show active" role="tabpanel">
                                    ...
                                    <table width="100%" class="table cell-border table-striped table-vcenter table-hover mb-0" id="senarai_kewangan_rt_table2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #999999; border:1px solid;"><font color="white"><b>Tarikh<br> Penerimaan /Pembayaran</b></font></th>
                                                <th style="background-color: #999999; border:1px solid;"><font color="white"><b>No Cek / No Baucer</b></font></th>
                                                <th style="background-color: #999999; border:1px solid;"><font color="white"><b>Tarikh Cek / Tarikh Baucer</b></font></th>
						...
						<div class="card-body" id="div_tindakan" name="div_tindakan" style="display:none; ">
                                <div class="row">
                                	<div class="col-sm-4">
										<label class="form-label">Tindakan Pengerusi: <span class="text-red">*</span></label>
