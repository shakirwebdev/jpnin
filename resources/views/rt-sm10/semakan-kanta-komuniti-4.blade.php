...
@section('title', 'Semakan Permohonan Kanta Komuniti')
                                            ...
                                            <div class="col-12">
                                                ...
                                                @csrf
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="skk_status" id="skk_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="6" >Disemak</option>
                                                            <option value="5" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_skk_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="skk_disemak_note"id="skk_disemak_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_skk_disemak_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="skk_kanta_komuniti_id" id="skk_kanta_komuniti_id">
                                                            <input type="hidden" name="post_semakan_kanta_komuniti" value="edit">
                                                            <input type="hidden" name="action" id="post_semakan_kanta_komuniti" value="edit">
...
@include('js.rt-sm10.j-semakan-kanta-komuniti-4')
