...
@section('title', 'Senarai Memperakui Permohonan Profil Skuad Uniti')
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="apsupn_daerah_id" name="apsupn_daerah_id">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="apsupn_krt_id" name="apsupn_krt_id" disabled>
                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                @foreach($krt as $item)                                    
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">Senarai Permohonan Skuad Uniti</h3>
                            </div>
...
@include('js.rt-sm10.j-akui-profil-skuad-uniti-krt')
