...
@section('title', 'REKOD PROFIL SKUAD UNITI')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_skuad_uniti_ppd')}}';"><i class="fe fe-plus mr-2"></i>Profil Skuad Uniti</button>
                </div>
            </div>
        </div>
    </div>
...
@include('js.rt-sm10.j-rekod-profil-skuad-unit')
