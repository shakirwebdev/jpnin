...
@section('title', 'SENARAI PENGESAHAN LAPORAN KEAKTIFAN KOPERASI KAWASAN RUKUN TETANGGA')
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI KOPERASI KAWASAN RUKUN TETANGGA</h3>
                            </div>
                                        ...
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_laporan_aktif_koperasi_krt" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Nama KRT</th>
                                                    <th>Nama Koperasi</th>
                                                    <th>Tarikh Daftar Koperasi KRT</th>
                                                    <th>Bilangan ALK</th>
...
@include('js.rt-sm10.j-senarai-p-laporan-aktif-koperasi-krt')
