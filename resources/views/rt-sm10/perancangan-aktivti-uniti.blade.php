...
@section('title', 'PERANCANGAN AKTIVTI DAN PERKHIDMATAN SKUAD UNITI')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_perancangan_skuad_uniti_ppd')}}';"><i class="fe fe-plus mr-2"></i>Perancangan Aktiviti dan Perkhidmatan Skuad Uniti</button>
                </div>
            </div>
        </div>
    </div>
...
@include('js.rt-sm10.j-perancangan-aktivti-uniti')
