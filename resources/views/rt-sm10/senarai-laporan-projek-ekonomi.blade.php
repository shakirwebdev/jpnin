...
@section('title', 'SENARAI LAPORAN KEMAJUAN PROJEK EKONOMI RUKUN TETANGGA')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_laporan_projek_ekonomi')}}';"><i class="fe fe-plus mr-2"></i>Rekod Laporan Kemajuan Projek Ekonomi RT</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI LAPORAN KEMAJUAN PROJEK EKONOMI RUKUN TETANGGA</h3>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_PERT" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Bil</th>
                                                    <th>Negeri</th>
...
@include('js.rt-sm10.j-senarai-laporan-projek-ekonomi')
