                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                                        ...
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Nama Agensi">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="form-label">Jenis Risiko : </label>
                                                                    <input type="text" class="form-control" name="" placeholder="Jenis Risiko">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="form-label">Isu / Kes : </label>
                                                                    <input type="text" class="form-control" name="" placeholder="Isu / Kes">
                                                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.add_profile_psk')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                        <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_psk_2')}}';">Seterusnya&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('js.rt-sm10.j-add-profile-psk-1')
