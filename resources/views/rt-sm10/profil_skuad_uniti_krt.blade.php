                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="" placeholder="Nama Skuad Uniti" >
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control">
                                                        ...
                                                        <option>Jiran Muda</option>
                                                        <option>Tunas Jiran</option>
                                                        <option>Jiran Wanita</option>
                                                        <option>Jiran Usia Emas</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="form-group">
                                                                    <label class="form-label">Nama Agensi / Badan: </label>
                                                                    <input type="text" class="form-control" name="" placeholder="Nama Penuh">
                                                                </div> 
                                                                <div class="form-group">
                                                                    <label class="form-label">Nama Pegawai / Rujukan: <span class="text-red">*</span></label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.rekod_profil_skuad_unit')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
