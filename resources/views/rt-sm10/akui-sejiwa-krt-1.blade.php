                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="ask1_status" id="ask1_status" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="ask1_disemak_note"id="ask1_disemak_note" placeholder="Penerangan" disabled></textarea>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">
...
@include('js.rt-sm10.j-akui-sejiwa-krt-1')
