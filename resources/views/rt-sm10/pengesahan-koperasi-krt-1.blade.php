...
@section('title', 'Pengesahan Permohonan Koperasi')
                                                ...
                                                @csrf
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="pkk_koperasi_krt_id" id="pkk_koperasi_krt_id">
                                                            <input type="hidden" name="post_pengesahan_koperasi" value="edit">
                                                            <input type="hidden" name="action" id="post_pengesahan_koperasi" value="edit">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pkk1_koperasi_nama" id="pkk1_koperasi_nama" placeholder="Nama Koperasi" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="pkk1_koperasi_tarikh_daftar" id="pkk1_koperasi_tarikh_daftar" placeholder="Tarikh Didaftarkan Sebagai Koperasi KRT" data-date-format="dd/mm/yyyy" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pkk1_koperasi_bilangan_ahli_lembaga" id="pkk1_koperasi_bilangan_ahli_lembaga" placeholder="Bilangan Ahli Lembaga Koperasi (ALK)" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Jumlah Anggota Koperasi: </label>
                                                            <input type="text" class="form-control" name="pkk1_koperasi_jumlah_anggota" id="pkk1_koperasi_jumlah_anggota" placeholder="Jumlah Anggota Koperasi" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-controls-stacked">
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" class="custom-control-input enable_tb" name="pkk1_status_koperasi_id" value="1" disabled>
                                                                    <span class="custom-control-label">Aktif</span>
                                                                </label>
                                                            </div>
                                                            <div class="custom-controls-stacked">
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" class="custom-control-input" name="pkk1_status_koperasi_id" value="2" disabled>
                                                                    <span class="custom-control-label">Tidak Aktif</span>
                                                                </label>
                                                            </div>
                                                            <div class="custom-controls-stacked">
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" class="custom-control-input" name="pkk1_status_koperasi_id" value="3" disabled>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pkk1_koperasi_pendapatan_semasa" id="pkk1_koperasi_pendapatan_semasa" placeholder="Jumlah Pendapatan Koperasi Bagi Tahun Semasa" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Jumlah Pendapatan Koperasi Bagi Tahun Sebelum: </label>
                                                            <input type="text" class="form-control" name="pkk1_koperasi_pendapatan_sebelum" id="pkk1_koperasi_pendapatan_sebelum" placeholder="Jumlah Pendapatan Koperasi Bagi Tahun Sebelum" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
...
@include('js.rt-sm10.j-pengesahan-koperasi-krt-1')
