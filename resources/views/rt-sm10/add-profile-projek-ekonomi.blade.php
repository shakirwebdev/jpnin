...
@section('title', 'PERMOHONAN PROJEK EKONOMI RUKUN TETANGGA BAHARU')
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="" placeholder="Nama Projek Ekonomi">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="" placeholder="Impak Kepada Komuniti">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.senarai_projek_ekonomi')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
...
@include('js.rt-sm10.j-add-profile-projek-ekonomi')
