...
@section('title', 'REKOD PROFIL SEJIWA (SKUAD ELIT JIRAN WANITA)')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_sejiwa_ppd')}}';"><i class="fe fe-plus mr-2"></i>Profil SeJIWA</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">Senarai SeJIWA (SKUAD ELIT JIRAN WANITA)</h3>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senari_Sejiwa" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Bil</th>
                                                    <th>Negeri</th>
                                                    <th>Daerah</th>
                                                    <th>Nama SeJIWA <br> (SKUAD ELIT JIRAN WANITA)</th>
                                                    <th>Tarikh Penubuhan Skuad</th>
                                                    <th>Jumlah Ahli</th>
                                                    <th>Pegawai Rujukan / <br> Penyelia SeJIWA</th>
                                                    <th>Status</th>
                                                    <th>Tindakan</th>
                                                </tr>
                                            </thead>
...
@include('js.rt-sm10.j-rekod-profil-sejiwa')
