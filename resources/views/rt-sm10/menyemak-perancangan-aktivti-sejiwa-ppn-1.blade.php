                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <h6><b>MAKLUMAT PERANCANGAN AKTIVITI / PERKHIDMATAN</b></h6>
                                            <br>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <table class="table thead-dark table-bordered table-striped" id="perancangan_table" style="width: 100%" border="1">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th><label class="form-label text-center"><font color="#113f50">Perancangan Aktiviti / Perkhidmatan</font></label></th>
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.memperakui_perancangan_aktivti_sejiwa_ppn')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
...
@include('js.rt-sm10.j-menyemak-perancangan-aktivti-sejiwa-ppn-1')
