...
@section('title', 'SENARAI PENGESAHAN KOPERASI KAWASAN RUKUN TETANGGA')
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_koperasi_krt" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Bil</th>
                                                    <th>Negeri</th>
...
@include('js.rt-sm10.j-senarai-pengesahan-koperasi-krt')
