                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_apsupn">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="apsupn_status" id="apsupn_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="1" >Diakui</option>
                                                            <option value="7" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_apsupn_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="apsupn_diakui_note"id="apsupn_diakui_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_apsupn_diakui_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="apsupn_skuad_uniti_id" id="apsupn_skuad_uniti_id">
                                                            <input type="hidden" name="post_akui_profile_skuad_uniti" value="edit">
                                                            <input type="hidden" name="action" id="post_akui_profile_skuad_uniti" value="edit">
                                                            <button type="submit" id="btn_submit" class="btn btn-primary">Hantar Status Memperakui&nbsp;&nbsp;<i class="dropdown-icon fa fa-paper-plane"></i></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
@include('js.rt-sm10.j-akui-profil-skuad-uniti-krt-1')
