...
@section('title', 'Senarai Permohonan Profil Skuad Uniti')
...
@section('content')
    ...
    <div class="section-body">
        <form method="POST" action="{{ route('rt-sm10.post_tambah_profile_skuad_uniti') }}">
        @csrf
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>&nbsp;</div>
                    <div class="header-action">
                        <input type="hidden" name="add_profile_skuad_uniti" value="add">
                        <button type="submit" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Permohonan Profil Skuad Uniti</button>
                    </div>
                </div>
            </div>
        </form>
...
@include('js.rt-sm10.j-profil-skuad-uniti-krt')
