                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row clearfix">
                                                    ...
                                                    <br><br>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <p><span style="font-size:12px">Nama Kawasan Rukun Tetangga (KRT)</span><br><b><span id="ssk2_nama_krt" name="ssk2_nama_krt"></span></b></p>
                                                        <p><span style="font-size:12px">Alamat Kawasan Rukun Tetangga (KRT)</span><br><b><span id="ssk2_alamat_krt" name="ssk2_alamat_krt"></span></b></p>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <p><span style="font-size:12px">Negeri</span><br><b><span id="ssk2_negeri_krt" name="ssk2_negeri_krt"></span></b></p>
                                                        <p><span style="font-size:12px">Parlimen</span><br><b><span id="ssk2_parlimen_krt" name="ssk2_parlimen_krt"></span></b></p>
                                                        <p><span style="font-size:12px">Pihak Berkuasa Tempatan</span><br><b><span id="ssk2_pbt_krt" name="ssk2_pbt_krt"></span></b></p>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <p><span style="font-size:12px">Daerah</span><br><b><span id="ssk2_daerah_krt" name="ssk2_daerah_krt"></span></b></p>
                                                        <p><span style="font-size:12px">Dun</span><br><b><span id="ssk2_dun_krt" name="ssk2_dun_krt"></span></b></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ssk2_sejiwa_nama" id="ssk2_sejiwa_nama" placeholder="Nama Sejiwa" disabled>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="ssk2_sejiwa_tarikh_ditubuhkan" id="ssk2_sejiwa_tarikh_ditubuhkan" placeholder="Tarikh Penubuhan Sejiwa" data-date-format="dd/mm/yyyy" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Pusat Operasi Sejiwa: </label>
                                                    <input type="text" class="form-control" name="ssk2_sejiwa_pusat_operasi" id="ssk2_sejiwa_pusat_operasi" placeholder="Pusat Operasi Sejiwa" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_ssk2">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="ssk2_status" id="ssk2_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="6" >Disemak</option>
                                                            <option value="5" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_ssk2_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="ssk2_disemak_note"id="ssk2_disemak_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_ssk2_disemak_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="ssk2_sejiwa_id" id="ssk2_sejiwa_id">
                                                            <input type="hidden" name="post_semakan_profile_sejiwa" value="edit">
                                                            <input type="hidden" name="action" id="post_semakan_profile_sejiwa" value="edit">
...
@include('js.rt-sm10.j-semakan-sejiwa-krt-2')
