                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                                        ...
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Perincian Isu">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="form-label">Penjelasan Isu : </label>
                                                                    <input type="text" class="form-control" name="" placeholder="Penjelasan Isu">
                                                                </div>
                                                        ...
                                                        <div class="series-frame">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="" placeholder="Status Keaktifan">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="form-label">Isu / Masalah : </label>
                                                                    <input type="text" class="form-control" name="" placeholder="Isu / Masalah">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.add_profile_psk_1')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                        <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_psk_3')}}';">Seterusnya&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('js.rt-sm10.j-add-profile-psk-2')
