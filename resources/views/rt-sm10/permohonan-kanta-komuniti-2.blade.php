                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <br>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <form action="#" id="form_pkk4">
                                                    {{ csrf_field() }}
                                                    <div class="row clearfix">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <p>Risiko Lokasi (Hotspot / Blackspot) : <span class="text-red">*</span></p> 
                                                            <hr class="mt-1">
                                                            <div class="col-md-12 alert alert-danger error_form_pkk4" role="alert" style="display: none; padding-bottom: 0px;">
                                                                <ul></ul>
                                                            </div>
                                                            <div class="series-frame">
                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="pkk4_risiko_nama_agensi" id="pkk4_risiko_nama_agensi" placeholder="Nama Agensi">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label">Jenis Risiko : </label>
                                                                        <input type="text" class="form-control" name="pkk4_risiko_jenis" id="pkk4_risiko_jenis" placeholder="Jenis Risiko">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label">Isu / Kes : </label>
                                                                        <input type="text" class="form-control" name="pkk4_risiko_isu" id="pkk4_risiko_isu" placeholder="Isu / Kes">
                                                                    </div>
                                                                    <input type="hidden" name="pkk4_kanta_komuniti_id" id="pkk4_kanta_komuniti_id">
                                                                    <input type="hidden" name="add_kanta_komuniti_risiko" value="add">
                                                                    <button type="submit" class="btn btn-primary pull-right" id="btn_save_risiko"><i class="fe fe-plus mr-2"></i>Tambah</button>
                                                                </div>
                                                            </div>
                                                            <br/><br/>
                                                ...
                                                <form method="POST" id="form_pkk5">
                                                    @csrf
                                                    <div class="form-group">
                                                            <label class="form-label">Sejarah dan Latar Belakang Lokasi : </label>
                                                            <textarea class="form-control" rows="5" name="pkk5_kanta_sejarah_lokasi" id="pkk5_kanta_sejarah_lokasi"></textarea>
                                                            <div class="error_pkk5_kanta_sejarah_lokasi invalid-feedback text-right"></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="5" name="pkk5_kanta_kelebihan_lokasi" id="pkk5_kanta_kelebihan_lokasi"></textarea>
                                                            <div class="error_pkk5_kanta_kelebihan_lokasi invalid-feedback text-right"></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="5" name="pkk5_kanta_kemudahan" id="pkk5_kanta_kemudahan"></textarea>
                                                            <div class="error_pkk5_kanta_kemudahan invalid-feedback text-right"></div>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <br>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form method="POST" id="form_pkk6">
                                            @csrf
                                                <input type="hidden" name="pkk6_kanta_komuniti_id" id="pkk6_kanta_komuniti_id">
                                                <input type="hidden" name="action" id="post_permohonan_kanta_komuniti_2" value="edit">
                                                <input type="hidden" name="post_permohonan_kanta_komuniti_2" value="edit">
...
@include('js.rt-sm10.j-permohonan-kanta-komuniti-2')
