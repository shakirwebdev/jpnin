...
@section('title', 'Perakui Permohonan Sejiwa')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_ask2">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="ask2_status" id="ask2_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="1" >Diakui</option>
                                                            <option value="7" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_ask2_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="ask2_diakui_note"id="ask2_diakui_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_ask2_diakui_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="ask2_sejiwa_id" id="ask2_sejiwa_id">
                                                            <input type="hidden" name="post_akui_profile_sejiwa" value="edit">
                                                            <input type="hidden" name="action" id="post_akui_profile_sejiwa" value="edit">
...
@include('js.rt-sm10.j-akui-sejiwa-krt-2')
