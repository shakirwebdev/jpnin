...
@section('title', 'Semakan Permohonan Koperasi')
                                                ...
                                                @csrf
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="skk_koperasi_krt_id" id="skk_koperasi_krt_id">
                                                            <input type="hidden" name="post_semakan_koperasi" value="edit">
                                                            <input type="hidden" name="action" id="post_semakan_koperasi" value="edit">
...
@include('js.rt-sm10.j-semakan-koperasi-krt-1')
