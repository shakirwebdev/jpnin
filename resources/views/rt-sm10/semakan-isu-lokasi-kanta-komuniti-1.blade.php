...
@section('title', 'Semakan Isu Dan Masalah Di Lokasi Kanta Komuniti')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_silkk1">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="silkk1_status" id="silkk1_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="6" >Disemak</option>
                                                            <option value="5" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_silkk1_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="silkk1_disemak_note"id="silkk1_disemak_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_silkk1_disemak_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="silkk1_isu_lokasi_kk_id" id="silkk1_isu_lokasi_kk_id">
                                                            <input type="hidden" name="post_semakan_isu_lokasi_kanta_komuniti" value="edit">
                                                            <input type="hidden" name="action" id="post_semakan_isu_lokasi_kanta_komuniti" value="edit">
...
@include('js.rt-sm10.j-semakan-isu-lokasi-kanta-komuniti-1')
