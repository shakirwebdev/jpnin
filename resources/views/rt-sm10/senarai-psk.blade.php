...
@section('title', 'PROGRAM SAYANGI KOMUNITI (PSK)')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_psk')}}';"><i class="fe fe-plus mr-2"></i>Profil Program Sayangi Komuniti</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI PROGRAM SAYANGI KOMUNIT (PSK)</h3>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senari_PSK" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Bil</th>
                                                    <th>Negeri</th>
                                                    <th>Daerah</th>
                                                    <th>Nama Lokasi PSK</th>
                                                    <th>Jenis Perumahan</th>
                                                    <th>Isu / Masalah Lokasi PSK</th>
                                                    <th>Komposasi Penduduk</th>
                                                    <th>Status</th>
                                                    <th>Tindakan</th>
                                                </tr>
                                            </thead>
...
@include('js.rt-sm10.j-senarai-psk')
