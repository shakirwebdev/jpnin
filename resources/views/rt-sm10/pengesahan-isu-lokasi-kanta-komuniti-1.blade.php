...
@section('title', 'Pengesahan Isu Dan Masalah Di Lokasi Kanta Komuniti')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <br><br>
                                                <form method="POST" id="form_pilkk">
                                                @csrf
                                                    <div class="form-group">
                                                        <label class="form-label">Status: <span class="text-red">*</span></label>
                                                        <select class="form-control" name="pilkk_status" id="pilkk_status">
                                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                            <option value="1" >Disahkan</option>
                                                            <option value="7" >Perlu Dikemaskini</option>
                                                        </select>
                                                        <div class="error_pilkk_status invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Penerangan: <span class="text-red">*</span></label>
                                                        <textarea class="form-control" rows="4" name="pilkk_disahkan_note"id="pilkk_disahkan_note" placeholder="Penerangan"></textarea>
                                                        <div class="error_pilkk_disahkan_note invalid-feedback text-right"></div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group pull-right">
                                                            <input type="hidden" name="pilkk_koperasi_krt_id" id="pilkk_koperasi_krt_id">
                                                            <input type="hidden" name="post_pengesahan_isu_lokasi_kanta_komuniti" value="edit">
                                                            <input type="hidden" name="action" id="post_pengesahan_isu_lokasi_kanta_komuniti" value="edit">
...
@include('js.rt-sm10.j-pengesahan-isu-lokasi-kanta-komuniti-1')
