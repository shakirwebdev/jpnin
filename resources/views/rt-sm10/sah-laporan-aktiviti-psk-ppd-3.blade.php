                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm10.add_laporan_aktiviti_psk_1')}}';" disabled="">Seterusnya&nbsp;<i class="dropdown-icon fe fe-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
