                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sskhqrt_state_id" id="sskhqrt_state_id">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sskhqrt_daerah_id" id="sskhqrt_daerah_id" disabled>
                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sskhqrt_krt_id" id="sskhqrt_krt_id" disabled>
                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                @foreach($krt as $item)                                    
...
@include('js.rt-sm10.j-senarai-sejiwa-krt-hqrt')
