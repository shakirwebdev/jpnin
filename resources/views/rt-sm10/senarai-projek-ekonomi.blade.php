...
@section('title', 'SENARAI PERMOHONAN PROJEK EKONOMI RUKUN TETANGGA')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_profile_projek_ekonomi')}}';"><i class="fe fe-plus mr-2"></i>Permohonan Projek Ekonomi Rukun Tetangga Baharu</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI PERMOHONAN PROJEK EKONOMI RUKUN TETANGGA</h3>
                            </div>
...
@include('js.rt-sm10.j-senarai-projek-ekonomi')
