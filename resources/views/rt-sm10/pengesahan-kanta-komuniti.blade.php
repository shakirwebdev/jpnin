                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                         <div class="form-group">
                                            ...
                                            <select class="custom-select" id="pkkhq_state_id" name="pkkhq_state_id">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="pkkhq_daerah_id" name="pkkhq_daerah_id" disabled>
                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        ...
                                        <table class="table table-striped table-vcenter table-hover mb-0" id="senarai_permohonan_kanta_komuniti" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #113f50"><font color="white">Nama Kanta Komuniti</font></th>
                                                    <th style="background-color: #113f50"><font color="white">Alamat Kanta Komuniti</font></th>
...
@include('js.rt-sm10.j-pengesahan-kanta-komuniti')
