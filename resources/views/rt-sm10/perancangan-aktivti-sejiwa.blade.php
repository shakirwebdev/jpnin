...
@section('title', 'PERANCANGAN AKTIVTI DAN PERKHIDMATAN SEJIWA')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm10.add_perancangan_sejiwa_ppd')}}';"><i class="fe fe-plus mr-2"></i>Perancangan Aktiviti dan Perkhidmatan SeJIWA</button>
                </div>
            </div>
        </div>
    </div>
...
@include('js.rt-sm10.j-perancangan-aktivti-sejiwa')
