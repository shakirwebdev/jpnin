...
@section('title', 'Pengesahan Permohonan Projek Ekonomi RT')
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="ppekpn_daerah_id" name="ppekpn_daerah_id">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <select class="custom-select" id="ppekpn_krt_id" name="ppekpn_krt_id" disabled>
                                                <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                                @foreach($krt as $item)                                    
...
@include('js.rt-sm10.j-pengesahan-projek-ekonomi-krt')
