...
@section('title', 'SENARAI SEMAKAN PROJEK EKONOMI RUKUN TETANGGA')
            ...
            <div class="tab-content mt-3">
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-primary">SENARAI SEMAKAN PROJEK EKONOMI RUKUN TETANGGA</h3>
                            </div>
...
@include('js.rt-sm10.j-senarai-semakan-projek-ekonomi-ppd')
