...
@section('title', 'Jana Jadual Perancangan Rondaan SRS')
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jjrpn_daerah_id" id="jjrpn_daerah_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jjrpn_krt_id" id="jjrpn_krt_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jjrpn_srs_id" id="jjrpn_srs_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senari_perancangan_rondaan" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><font color="white">Tarikh Perancangan Rondaan</font></th>
...
@include('js.rt-sm15.j-jana-jadual-rondaan-ppn')
