                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="spkpd_krt_profile_id" id="spkpd_krt_profile_id">
                                    ...
                                    <table class="table table-striped table-vcenter table-hover mb-0" id="senari_pembatalan_krt" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #113f50"><font color="white">Tarikh Pembatalan</font></th>
                                                <th style="background-color: #113f50"><font color="white">Status Pembatalan</font></th>
...
@include('js.rt-sm8.j-senarai-pembatalan-krt-ppd')
