...
@section('title', 'BORANG PERMOHONAN PEMBATALAN KAWASAN RUKUN TERTANGGA (KRT)')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content mt-3">
                        <div class="alert alert-warning alert-dismissible fade show small" role="alert">
                            <div class="mb-10">
                                <code><span style="text-size: 16px;"><strong>No Rujukan Permohonan : </strong></span></code>
                                <br>
                                <br>
                                Permohonan Pembatalan Kawasan Rukun Tetangga (KRT) sedang dalam proses tindakan dan pengesahan oleh pihak Pengarah Perpaduan Negeri (PPN) dan Pegawai Perpaduan Daerah (PPD). 
                                <br>
                                <br>
                                ...
                                <br>
                                <br>
                                Jika permohonan sudah disemak oleh pihak Pengarah Perpaduan Negeri (PPN) dan Pegawai Perpaduan Daerah (PPD), maklumat yang dibekalkan oleh pemohon tidak dapat membuat perubahan.  
                            </div>
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{route('rt-sm8.permohonan_pembatalan_krt_admin')}}';"><i class="dropdown-icon fe fe-arrow-left"></i>&nbsp;Kembali</button>
                                            <button type="submit" class="btn btn-primary">Hantar Permohonan Pembatalan KRT&nbsp;&nbsp;<i class="dropdown-icon fa fa-paper-plane"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('js.rt-sm8.j-permohonan-pembatalan-krt-admin')
