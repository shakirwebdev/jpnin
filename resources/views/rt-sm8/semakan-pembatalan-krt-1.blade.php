...
@section('title', 'Semakan Permohonan Pembatalan KRT')
                                        ...
                                        <div class="col-12">
                                            ...
                                            @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="spk_disemak_note"id="spk_disemak_note" placeholder="Penerangan"></textarea>
                                                    <div class="error_spk_disemak_note invalid-feedback text-right"></div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group pull-right">
                                                        <input type="hidden" name="spk_pembatalan_id" id="spk_pembatalan_id">
                                                        <input type="hidden" name="post_semakan_pembatalan_krt" value="edit">
                                                        <input type="hidden" name="action" id="post_semakan_pembatalan_krt" value="edit">
...
@include('js.rt-sm8.j-semakan-pembatalan-krt-1')
