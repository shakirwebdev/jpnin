...
@section('title', 'SEMAK PERMOHONAN PEMBATALAN KRT')
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="header-action">
                    <button type="button" class="btn btn-primary" onclick="window.location.href = '{{route('rt-sm8.permohonan_pembatalan_krt_admin')}}';"><i class="fe fe-plus mr-2"></i>Permohonan Pembatalan KRT</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tab-pane fade show active" id="Departments-list" role="tabpanel">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-primary">Senarai Pemohonan</h3>
                        </div>
...
@include('js.rt-sm8.j-semak-permohonan-pembatalan-krt-admin')
