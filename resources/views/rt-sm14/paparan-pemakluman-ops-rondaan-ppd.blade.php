                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="pporpd_krt_id" id="pporpd_krt_id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="pporpd_srs_id" id="pporpd_srs_id" disabled>
                                            <option value="" disabled selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
...
@include('js.rt-sm14.j-paparan-pemakluman-ops-rondaan-ppd')
