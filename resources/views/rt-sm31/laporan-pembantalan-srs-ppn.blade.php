                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpspn_daerah_id" name="lpspn_daerah_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpspn_krt_id" name="lpspn_krt_id" disabled>
...
@include('js.rt-sm31.j-laporan-pembantalan-srs-ppn')