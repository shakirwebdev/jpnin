                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpksrspn_year_id" name="lpksrspn_year_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpksrspn_daerah_id" name="lpksrspn_daerah_id">
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpksrspn_krt_id" name="lpksrspn_krt_id" disabled>
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lpksrspn_srs_id" name="lpksrspn_srs_id" disabled>
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
...
@include('js.rt-sm31.j-laporan-pengendalian-kes-srs-ppn')