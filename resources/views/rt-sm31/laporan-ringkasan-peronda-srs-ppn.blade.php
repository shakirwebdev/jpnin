                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lrppn_daerah_id" name="lrppn_daerah_id">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lrppn_parlimen_id" name="lrppn_parlimen_id">
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lrppn_dun_id" name="lrppn_dun_id" disabled>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lrppn_krt_id" name="lrppn_krt_id" disabled>
                                            <option value="" selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lrppn_srs_id" name="lrppn_srs_id" disabled>
                                            <option value="" selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
...
@include('js.rt-sm31.j-laporan-ringkasan-peronda-srs-ppn')