                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lksrspn_daerah_id" name="lksrspn_daerah_id" >
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="lksrspn_krt_id" name="lksrspn_krt_id" disabled>
                                            <option value=""  selected hidden style="color: #a9a9a9 !important;">-- Sila Pilih --</option>
                                        </select>
                                    </div>
                                </div>
...
@include('js.rt-sm31.j-laporan-rondaan-srs-ppn')